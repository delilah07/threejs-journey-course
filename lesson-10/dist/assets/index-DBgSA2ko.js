...
class Ct {
  ...
  scale(t, e) {
    return this.premultiply(xr.makeScale(t, e)), this;
  }
  rotate(t) {
    return this.premultiply(xr.makeRotation(-t)), this;
  }
  translate(t, e) {
    return this.premultiply(xr.makeTranslation(t, e)), this;
  }
  makeTranslation(t, e) {
    return (
      t.isVector2
...
function Bl() {
  const i = {
        ...
        return (
          this.enabled === !1 ||
            ...
            (this.spaces[s].transfer === qt &&
              ((r.r = nn(r.r)), (r.g = nn(r.g)), (r.b = nn(r.b))),
            ...
            this.spaces[a].transfer === qt &&
              ((r.r = ai(r.r)), (r.g = ai(r.g)), (r.b = ai(r.b)))),
          r
        );
      },
      ...
      getTransfer: function (r) {
        return r === fn ? cr : this.spaces[r].transfer;
      },
  ...
  static sRGBToLinear(t) {
    if (
      ...
      const r = n.getImageData(0, 0, t.width, t.height),
        s = r.data;
      for (let a = 0; a < s.length; a++) s[a] = nn(s[a] / 255) * 255;
      return n.putImageData(r, 0, 0), e;
    } else if (t.data) {
      const e = t.data.slice(0);
      for (let n = 0; n < e.length; n++)
        e instanceof Uint8Array || e instanceof Uint8ClampedArray
          ? (e[n] = Math.floor(nn(e[n] / 255) * 255))
          : (e[n] = nn(e[n]));
      ...
      return (
        y > T && y > U
          ? y < 0.01
            ...
            : ((n = Math.sqrt(y)), (r = D / n), (s = R / n))
          : T > U
          ? T < 0.01
            ? ((n = 0.707106781), (r = 0), (s = 0.707106781))
            : ((r = Math.sqrt(T)), (n = D / r), (s = I / r))
          : U < 0.01
          ? ((n = 0.707106781), (r = 0.707106781), (s = 0))
          : ((s = Math.sqrt(U)), (n = R / s), (r = I / s)),
        this.set(n, r, s, e),
        this
      );
    }
...
class Gl extends On {
  ...
  copy(t) {
    ...
    for (let e = 0, n = t.textures.length; e < n; e++) {
      ...
      this.textures[e].source = new Vs(r);
    }
    return (
...
class F {
  ...
  applyEuler(t) {
    return this.applyQuaternion(ua.setFromEuler(t));
  }
  applyAxisAngle(t, e) {
...
class wi {
  ...
  intersectsTriangle(t) {
    ...
    this.getCenter(vi),
      Ni.subVectors(this.max, vi),
      kn.subVectors(t.a, vi),
      Wn.subVectors(t.b, vi),
      Xn.subVectors(t.c, vi),
      an.subVectors(Wn, kn),
      on.subVectors(Xn, Wn),
      Sn.subVectors(kn, Xn);
    let e = [
    ...
    return !Er(e, kn, Wn, Xn, Ni) ||
      ((e = [1, 0, 0, 0, 1, 0, 0, 0, 1]), !Er(e, kn, Wn, Xn, Ni))
      ? !1
      : (Fi.crossVectors(an, on),
        (e = [Fi.x, Fi.y, Fi.z]),
        Er(e, kn, Wn, Xn, Ni));
  }
  clampPoint(t, e) {
...
class Gs {
  ...
  setFromPoints(t, e) {
    const n = this.center;
    e !== void 0 ? n.copy(e) : Wl.setFromPoints(t).getCenter(n);
    let r = 0;
  ...
  union(t) {
    return t.isEmpty()
      ...
      : (this.center.equals(t.center) === !0
          ...
          : (Tr.subVectors(t.center, this.center).setLength(t.radius),
            this.expandByPoint(xi.copy(t.center).add(Tr)),
            this.expandByPoint(xi.copy(t.center).sub(Tr))),
        this);
  }
  equals(t) {
...
class vo {
  ...
  distanceSqToPoint(t) {
    ...
    return e < 0
      ...
      : (Ze.copy(this.origin).addScaledVector(this.direction, e),
        Ze.distanceToSquared(t));
  }
  distanceSqToSegment(t, e, n, r) {
    yr.copy(t).add(e).multiplyScalar(0.5),
      Oi.copy(e).sub(t).normalize(),
      ln.copy(this.origin).sub(yr);
    const s = t.distanceTo(e) * 0.5,
      a = -this.direction.dot(Oi),
    ...
    return (
      ...
      r && r.copy(yr).addScaledVector(Oi, f),
      m
    );
  }
  intersectSphere(t, e) {
    Ze.subVectors(t.center, this.origin);
    const n = Ze.dot(this.direction),
      r = Ze.dot(Ze) - n * n,
      s = t.radius * t.radius;
    if (r > s) return null;
  ...
  intersectTriangle(t, e, n, r, s) {
    br.subVectors(e, t), Bi.subVectors(n, t), Ar.crossVectors(br, Bi);
    let a = this.direction.dot(Ar),
      o;
    if (a > 0) {
      if (r) return null;
      o = 1;
    ...
    const l = o * this.direction.dot(Bi.crossVectors(ln, Bi));
    if (l < 0) return null;
    const c = o * this.direction.dot(br.cross(ln));
...
class oe {
  ...
  extractRotation(t) {
    const e = this.elements,
      ...
      a = 1 / Yn.setFromMatrixColumn(t, 2).length();
    return (
      (e[0] = n[0] * r),
      (e[1] = n[1] * r),
      (e[2] = n[2] * r),
  ...
  makeRotationFromQuaternion(t) {
    return this.compose(Xl, t, Yl);
  }
  lookAt(t, e, n) {
    const r = this.elements;
    return (
      ye.subVectors(t, e),
      ye.lengthSq() === 0 && (ye.z = 1),
      ye.normalize(),
      cn.crossVectors(n, ye),
      cn.lengthSq() === 0 &&
        (Math.abs(n.z) === 1 ? (ye.x += 1e-4) : (ye.z += 1e-4),
        ye.normalize(),
        cn.crossVectors(n, ye)),
      cn.normalize(),
      zi.crossVectors(ye, cn),
      (r[0] = cn.x),
      (r[4] = zi.x),
      (r[8] = ye.x),
      (r[1] = cn.y),
  ...
  multiplyMatrices(t, e) {
    ...
    return (
      (s[0] = a * D + o * x + l * Z + c * V),
      (s[4] = a * R + o * w + l * K + c * rt),
      (s[8] = a * I + o * k + l * X + c * ht),
      (s[12] = a * S + o * z + l * $ + c * vt),
      (s[1] = u * D + d * x + f * Z + m * V),
      (s[5] = u * R + d * w + f * K + m * rt),
      (s[9] = u * I + d * k + f * X + m * ht),
      (s[13] = u * S + d * z + f * $ + m * vt),
      (s[2] = v * D + M * x + p * Z + h * V),
      (s[6] = v * R + M * w + p * K + h * rt),
      (s[10] = v * I + M * k + p * X + h * ht),
      (s[14] = v * S + M * z + p * $ + h * vt),
      (s[3] = A * D + y * x + T * Z + U * V),
      (s[7] = A * R + y * w + T * K + U * rt),
      (s[11] = A * I + y * k + T * X + U * ht),
      (s[15] = A * S + y * z + T * $ + U * vt),
      this
    );
  }
  ...
  invert() {
    const t = this.elements,
      ...
      p = t[14],
      h = t[15],
      A = d * p * c - M * f * c + M * l * m - o * p * m - d * l * h + o * f * h,
      y = v * f * c - u * p * c - v * l * m + a * p * m + u * l * h - a * f * h,
      T = u * M * c - v * d * c + v * o * m - a * M * m - u * o * h + a * d * h,
      U = v * d * l - u * M * l - v * o * f + a * M * f + u * o * p - a * d * p,
      D = e * A + n * y + r * T + s * U;
    if (D === 0)
  ...
  makePerspective(t, e, n, r, s, a, o = en) {
    ...
    else if (o === hr) (m = -a / (a - s)), (v = (-a * s) / (a - s));
    else
      throw new Error(
  ...
  makeOrthographic(t, e, n, r, s, a, o = en) {
    const l = this.elements,
      ...
      m = (n + r) * u;
    let v, M;
    if (o === en) (v = (a + s) * d), (M = -2 * d);
    else if (o === hr) (v = s * d), (M = -1 * d);
    else
      throw new Error(
...
class sn {
  ...
  setFromQuaternion(t, e, n) {
    return (
      da.makeRotationFromQuaternion(t), this.setFromRotationMatrix(da, e, n)
    );
  }
  ...
  reorder(t) {
    return fa.setFromEuler(this), this.setFromQuaternion(fa, t);
  }
  equals(t) {
    return (
      t._x === this._x &&
...
class we extends On {
  ...
  translateOnAxis(t, e) {
    return (
      pa.copy(t).applyQuaternion(this.quaternion),
      this.position.add(pa.multiplyScalar(e)),
      this
    );
  }
  translateX(t) {
  ...
  lookAt(t, e, n) {
    ...
    this.updateWorldMatrix(!0, !1),
      ...
      this.isCamera || this.isLight
        ? Ke.lookAt(Mi, Hi, this.up)
        : Ke.lookAt(Hi, Mi, this.up),
      this.quaternion.setFromRotationMatrix(Ke),
      r &&
        (Ke.extractRotation(r.matrixWorld),
        qn.setFromRotationMatrix(Ke),
  ...
  getWorldQuaternion(t) {
    return (
      this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(Mi, t, Zl), t
    );
  }
  getWorldScale(t) {
    return (
      this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(Mi, Kl, t), t
    );
  }
  getWorldDirection(t) {
    this.updateWorldMatrix(!0, !1);
...
class ze {
  ...
  static containsPoint(t, e, n, r) {
    return this.getBarycoord(t, e, n, r, $e) === null
      ? !1
  ...
  static getInterpolation(t, e, n, r, s, a, o, l) {
    return this.getBarycoord(t, e, n, r, $e) === null
      ? ((l.x = 0),
        ...
        null)
      : (l.setScalar(0),
        l.addScaledVector(s, $e.x),
        l.addScaledVector(a, $e.y),
        l.addScaledVector(o, $e.z),
        l);
  }
  static getInterpolatedAttribute(t, e, n, r, s, a) {
    return (
      ...
      Ur.fromBufferAttribute(t, n),
      Ir.fromBufferAttribute(t, r),
      a.setScalar(0),
      a.addScaledVector(Lr, s.x),
      a.addScaledVector(Ur, s.y),
      a.addScaledVector(Ir, s.z),
      a
    );
  }
  ...
  getInterpolation(t, e, n, r, s) {
    return ze.getInterpolation(t, this.a, this.b, this.c, e, n, r, s);
  }
  containsPoint(t) {
  ...
  closestPointToPoint(t, e) {
    const n = this.a,
      ...
      s = this.c;
    let a, o;
    Kn.subVectors(r, n), jn.subVectors(s, n), Cr.subVectors(t, n);
    const l = Kn.dot(Cr),
      c = jn.dot(Cr);
    ...
    const f = l * d - u * c;
    if (f <= 0 && l >= 0 && u <= 0)
      return (a = l / (l - u)), e.copy(n).addScaledVector(Kn, a);
    Dr.subVectors(t, s);
    const m = Kn.dot(Dr),
      v = jn.dot(Dr);
    ...
    const M = m * c - l * v;
    if (M <= 0 && c >= 0 && v <= 0)
      return (o = c / (c - v)), e.copy(n).addScaledVector(jn, o);
    const p = u * v - m * d;
    if (p <= 0 && d - u >= 0 && m - v >= 0)
      return (
        xa.subVectors(s, r),
        (o = (d - u) / (d - u + (m - v))),
        e.copy(r).addScaledVector(xa, o)
      );
    const h = 1 / (p + M + f);
    return (
      (a = M * h),
      (o = f * h),
      e.copy(n).addScaledVector(Kn, a).addScaledVector(jn, o)
    );
  }
  equals(t) {
...
class Kt {
  ...
  setRGB(t, e, n, r = Gt.workingColorSpace) {
    return (
      ...
      (this.g = e),
      (this.b = n),
      Gt.toWorkingColorSpace(this, r),
      this
    );
  }
  setHSL(t, e, n, r = Gt.workingColorSpace) {
    if (((t = Ll(t, 1)), (e = It(e, 0, 1)), (n = It(n, 0, 1)), e === 0))
  ...
  lerpHSL(t, e) {
    this.getHSL(hn), t.getHSL(Vi);
    const n = vr(hn.h, Vi.h, e),
      r = vr(hn.s, Vi.s, e),
      s = vr(hn.l, Vi.l, e);
...
class dr extends On {
  ...
  toJSON(t) {
    ...
    (n.uuid = this.uuid),
      ...
      this.blendSrc !== qr && (n.blendSrc = this.blendSrc),
      ...
      this.depthFunc !== oi && (n.depthFunc = this.depthFunc),
...
class Bn extends On {
        ...
        for (let n = 0, r = e.length; n < r; n++) {
          ...
          be.setFromBufferAttribute(s),
            this.morphTargetsRelative
              ? (ue.addVectors(this.boundingBox.min, be.min),
                this.boundingBox.expandByPoint(ue),
                ue.addVectors(this.boundingBox.max, be.max),
                this.boundingBox.expandByPoint(ue))
      ...
      if ((be.setFromBufferAttribute(t), e))
        for (let s = 0, a = e.length; s < a; s++) {
          ...
          Si.setFromBufferAttribute(o),
            this.morphTargetsRelative
              ? (ue.addVectors(be.min, Si.min),
                be.expandByPoint(ue),
                ue.addVectors(be.max, Si.max),
                be.expandByPoint(ue))
              : (be.expandByPoint(Si.min), be.expandByPoint(Si.max));
        }
      be.getCenter(n);
      let r = 0;
      for (let s = 0, a = t.count; s < a; s++)
        ue.fromBufferAttribute(t, s),
          (r = Math.max(r, n.distanceToSquared(ue)));
      if (e)
        for (let s = 0, a = e.length; s < a; s++) {
          const o = e[s],
          ...
          for (let c = 0, u = o.count; c < u; c++)
            ue.fromBufferAttribute(o, c),
              l && ($n.fromBufferAttribute(t, c), ue.add($n)),
              (r = Math.max(r, n.distanceToSquared(ue)));
        }
  ...
  computeTangents() {
    ...
    this.hasAttribute('tangent') === !1 &&
      this.setAttribute('tangent', new Xe(new Float32Array(4 * n.count), 4));
    ...
    for (let I = 0, S = A.length; I < S; ++I) {
      const x = A[I],
        w = x.start,
        k = x.count;
      for (let z = w, Z = w + k; z < Z; z += 3)
        h(t.getX(z + 0), t.getX(z + 1), t.getX(z + 2));
    }
    const y = new F(),
      T = new F(),
      U = new F(),
    ...
    function R(I) {
      ...
      const S = o[I];
      y.copy(S),
        y.sub(U.multiplyScalar(U.dot(S))).normalize(),
        T.crossVectors(D, S);
      const w = T.dot(l[I]) < 0 ? -1 : 1;
      a.setXYZW(I, y.x, y.y, y.z, w);
    }
    for (let I = 0, S = A.length; I < S; ++I) {
      const x = A[I],
        w = x.start,
  ...
  computeVertexNormals() {
    ...
    if (e !== void 0) {
      ...
      if (n === void 0)
        (n = new Xe(new Float32Array(e.count * 3), 3)),
...
class We extends we {
    ...
    if (s && o) {
      ...
      for (let l = 0, c = s.length; l < c; l++) {
        const u = o[l],
          d = s[l];
        u !== 0 &&
          (Or.fromBufferAttribute(d, t),
          a ? qi.addScaledVector(Or, u) : qi.addScaledVector(Or.sub(e), u));
      }
      e.add(qi);
    }
    return e;
  ...
  raycast(t, e) {
    ...
    r !== void 0 &&
      ...
      ki.applyMatrix4(s),
      Tn.copy(t.ray).recast(t.near),
      !(
        ki.containsPoint(Tn.origin) === !1 &&
        (Tn.intersectSphere(ki, Sa) === null ||
          Tn.origin.distanceToSquared(Sa) > (t.far - t.near) ** 2)
      ) &&
        (Ma.copy(s).invert(),
        Tn.copy(t.ray).applyMatrix4(Ma),
        !(n.boundingBox !== null && Tn.intersectsBox(n.boundingBox) === !1) &&
          this._computeIntersections(t, e, Tn)));
  }
    ...
    if (o !== null)
      if (Array.isArray(a))
        for (let v = 0, M = f.length; v < M; v++) {
          ...
          for (let T = A, U = y; T < U; T += 3) {
            const D = o.getX(T),
              R = o.getX(T + 1),
              I = o.getX(T + 2);
            (r = Ki(this, h, t, n, c, u, d, D, R, I)),
              r &&
...
function tc(i, t, e, n, r, s, a, o) {
  ...
  if (
    (t.side === Ee
      ...
      : (l = n.intersectTriangle(r, s, a, t.side === _n, o)),
    l === null)
  )
    return null;
...
function Ki(i, t, e, n, r, s, a, o, l, c) {
  i.getVertexPosition(o, Wi),
    i.getVertexPosition(l, Xi),
    i.getVertexPosition(c, Yi);
  const u = tc(i, t, e, n, Wi, Xi, Yi, Ea);
  if (u) {
    const d = new F();
    ze.getBarycoord(Ea, Wi, Xi, Yi, d),
      r && (u.uv = ze.getInterpolatedAttribute(r, o, l, c, d, new Lt())),
      s && (u.uv1 = ze.getInterpolatedAttribute(s, o, l, c, d, new Lt())),
      a &&
        ((u.normal = ze.getInterpolatedAttribute(a, o, l, c, d, new F())),
        u.normal.dot(n.direction) > 0 && u.normal.multiplyScalar(-1));
    const f = { a: o, b: l, c, normal: new F(), materialIndex: 0 };
    ze.getNormal(Wi, Xi, Yi, f.normal), (u.face = f), (u.barycoord = d);
  }
  return u;
}
class pi extends Bn {
  constructor(t = 1, e = 1, n = 1, r = 1, s = 1, a = 1) {
    ...
    v('z', 'y', 'x', -1, -1, n, e, t, a, s, 0),
      ...
      this.setIndex(l),
      this.setAttribute('position', new Un(c, 3)),
      this.setAttribute('normal', new Un(u, 3)),
      this.setAttribute('uv', new Un(d, 2));
    function v(M, p, h, A, y, T, U, D, R, I, S) {
      const x = T / R,
        w = U / I,
        k = T / 2,
        z = U / 2,
      ...
      for (let ht = 0; ht < I; ht++)
        for (let vt = 0; vt < R; vt++) {
          const Ut = f + vt + K * ht,
            ...
            W = f + (vt + 1) + K * (ht + 1),
            tt = f + (vt + 1) + K * ht;
          l.push(Ut, jt, tt), l.push(jt, W, tt), (V += 6);
        }
...
class gn extends dr {
  ...
  copy(t) {
    return (
      ...
      (this.uniforms = fi(t.uniforms)),
      (this.uniformsGroups = ec(t.uniformsGroups)),
...
class Ue extends yo {
  ...
  getEffectiveFOV() {
    return Ls * 2 * Math.atan(Math.tan(or * 0.5 * this.fov) / this.zoom);
  }
  getFilmWidth() {
  ...
  getViewBounds(t, e, n) {
    un.set(-1, -1, 0.5).applyMatrix4(this.projectionMatrixInverse),
      ...
      un.set(1, 1, 0.5).applyMatrix4(this.projectionMatrixInverse),
      n.set(un.x, un.y).multiplyScalar(-t / un.z);
  }
  getViewSize(t, e) {
    return this.getViewBounds(t, Ta, ya), e.subVectors(ya, Ta);
  }
...
class ac extends Nn {
  constructor(t = 1, e = {}) {
    ...
    (this.texture = new bo(
      ...
      (this.texture.minFilter = e.minFilter !== void 0 ? e.minFilter : ke);
  }
  fromEquirectangularTexture(t, e) {
    ...
    const a = new We(r, s),
      o = e.minFilter;
    return (
      e.minFilter === Ln && (e.minFilter = ke),
      new sc(1, 10, this).update(t, a),
      (e.minFilter = o),
      a.geometry.dispose(),
      a.material.dispose(),
      this
...
class dn {
  ...
  setFromCoplanarPoints(t, e, n) {
    const r = zr.subVectors(n, e).cross(cc.subVectors(t, e)).normalize();
  ...
  applyMatrix4(t, e) {
    const n = e || hc.getNormalMatrix(t),
...
class Ao {
  ...
  setFromProjectionMatrix(t, e = en) {
    ...
    if (
      ...
      n[2].setComponents(l + a, f + u, p + v, T + A).normalize(),
      n[3].setComponents(l - a, f - u, p - v, T - A).normalize(),
      n[4].setComponents(l - o, f - d, p - M, T - y).normalize(),
      e === en)
    )
      n[5].setComponents(l + o, f + d, p + M, T + y).normalize();
    else if (e === hr) n[5].setComponents(o, d, M, y).normalize();
    else
      throw new Error(
  ...
  intersectsObject(t) {
    if (t.boundingSphere !== void 0)
      t.boundingSphere === null && t.computeBoundingSphere(),
        yn.copy(t.boundingSphere).applyMatrix4(t.matrixWorld);
    else {
      const e = t.geometry;
...
class Ro extends ve {
  constructor(t, e, n, r, s, a, o, l, c, u = si) {
    if (u !== si && u !== ui)
      throw new Error(
    ...
    n === void 0 && u === si && (n = In),
      ...
      (this.magFilter = o !== void 0 ? o : Re),
      (this.minFilter = l !== void 0 ? l : Re),
      (this.flipY = !1),
      (this.generateMipmaps = !1),
  ...
  copy(t) {
    return (
      super.copy(t),
      (this.source = new Vs(Object.assign({}, t.image))),
...
class fr extends Bn {
  constructor(t = 1, e = 1, n = 1, r = 1) {
    ...
    for (let h = 0; h < u; h++) {
      ...
      for (let y = 0; y < c; y++) {
        const T = y * d - s;
        v.push(T, -A, 0), M.push(0, 0, 1), p.push(y / o), p.push(1 - h / l);
      }
    }
    for (let h = 0; h < l; h++)
      for (let A = 0; A < o; A++) {
        const y = A + c * h,
          ...
          U = A + 1 + c * (h + 1),
          D = A + 1 + c * h;
        m.push(y, T, D), m.push(T, U, D);
      }
    this.setIndex(m),
      this.setAttribute('position', new Un(v, 3)),
      this.setAttribute('normal', new Un(M, 3)),
      this.setAttribute('uv', new Un(p, 2));
  }
  copy(t) {
    return (
      super.copy(t), (this.parameters = Object.assign({}, t.parameters)), this
...
class pc extends Ws {
  ...
  load(t, e, n, r) {
    ...
    const o = yi('img');
    function l() {
      u(), ba.add(t, this), e && e(this), s.manager.itemEnd(t);
    }
    function c(d) {
      u(), r && r(d), s.manager.itemError(t), s.manager.itemEnd(t);
    }
    function u() {
...
#endif`,
  Dc = `#ifdef USE_BATCHING
	mat4 batchingMatrix = getBatchingMatrix( getIndirectIndex( gl_DrawID ) );
#endif`,
  Lc = `vec3 transformed = vec3( position );
#ifdef USE_ALPHAHASH
	vPosition = vec3( position );
#endif`,
  Uc = `vec3 objectNormal = vec3( normal );
#ifdef USE_TANGENT
...
#endif`,
  Xc = `#define PI 3.141592653589793
...
#endif`,
  qc = `vec3 transformedNormal = objectNormal;
#ifdef USE_TANGENT
...
transformedNormal = normalMatrix * transformedNormal;
  ...
  Qc = `vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
IncidentLight directLight;
  ...
  Eh = `#if defined( RE_IndirectDiffuse )
	...
	#endif
#endif`,
  Th = `#if defined( RE_IndirectDiffuse )
	RE_IndirectDiffuse( irradiance, geometryPosition, geometryNormal, geometryViewDir, geometryClearcoatNormal, material, reflectedLight );
#endif
#if defined( RE_IndirectSpecular )
	RE_IndirectSpecular( radiance, iblIrradiance, clearcoatRadiance, geometryPosition, geometryNormal, geometryViewDir, geometryClearcoatNormal, material, reflectedLight );
#endif`,
  yh = `#if defined( USE_LOGDEPTHBUF )
	gl_FragDepth = vIsPerspective == 0.0 ? gl_FragCoord.z : log2( vFragDepth ) * logDepthBufFC * 0.5;
#endif`,
  bh = `#if defined( USE_LOGDEPTHBUF )
...
#endif`,
  Ph = `#if defined( USE_MAP ) || defined( USE_ALPHAMAP )
...
#endif`,
  Uh = `#ifdef USE_METALNESSMAP
	uniform sampler2D metalnessMap;
#endif`,
  Ih = `#ifdef USE_INSTANCING_MORPH
...
#endif`,
  zh = `float faceDirection = gl_FrontFacing ? 1.0 : - 1.0;
#ifdef FLAT_SHADED
...
vec3 nonPerturbedNormal = normal;`,
  Hh = `#ifdef USE_NORMALMAP_OBJECTSPACE
...
#endif`,
  Xh = `#ifdef USE_CLEARCOAT
	vec3 clearcoatNormal = nonPerturbedNormal;
#endif`,
  Yh = `#ifdef USE_CLEARCOAT_NORMALMAP
	vec3 clearcoatMapN = texture2D( clearcoatNormalMap, vClearcoatNormalMapUv ).xyz * 2.0 - 1.0;
	clearcoatMapN.xy *= clearcoatNormalScale;
	clearcoatNormal = normalize( tbn2 * clearcoatMapN );
#endif`,
  qh = `#ifdef USE_CLEARCOATMAP
...
gl_FragColor = vec4( outgoingLight, diffuseColor.a );`,
  jh = `vec3 packNormalToRGB( const in vec3 normal ) {
...
#endif`,
  Jh = `vec4 mvPosition = vec4( transformed, 1.0 );
#ifdef USE_BATCHING
...
gl_Position = projectionMatrix * mvPosition;`,
  ...
  ru = `#if NUM_SPOT_LIGHT_COORDS > 0
	...
	#endif
#endif`,
  su = `#if ( defined( USE_SHADOWMAP ) && ( NUM_DIR_LIGHT_SHADOWS > 0 || NUM_POINT_LIGHT_SHADOWS > 0 ) ) || ( NUM_SPOT_LIGHT_COORDS > 0 )
...
#endif`,
  Mu = `#if defined( USE_ENVMAP ) || defined( DISTANCE ) || defined ( USE_SHADOWMAP ) || defined ( USE_TRANSMISSION ) || NUM_SPOT_LIGHT_COORDS > 0
...
void main() {
  ...
  Dt = {
    ...
    defaultnormal_vertex: qc,
    displacementmap_pars_vertex: Zc,
    ...
    envmap_physical_pars_fragment: ph,
    envmap_vertex: rh,
    fog_vertex: sh,
    fog_pars_vertex: ah,
    fog_fragment: oh,
    fog_pars_fragment: lh,
    ...
    logdepthbuf_pars_vertex: Ah,
    logdepthbuf_vertex: Rh,
    map_fragment: wh,
    map_pars_fragment: Ch,
    map_particle_fragment: Ph,
    map_particle_pars_fragment: Dh,
    metalnessmap_fragment: Lh,
    metalnessmap_pars_fragment: Uh,
    morphinstance_vertex: Ih,
    morphcolor_vertex: Nh,
    morphnormal_vertex: Fh,
    morphtarget_pars_vertex: Oh,
    morphtarget_vertex: Bh,
    normal_fragment_begin: zh,
    normal_fragment_maps: Hh,
    normal_pars_fragment: Vh,
    normal_pars_vertex: Gh,
    normal_vertex: kh,
    normalmap_pars_fragment: Wh,
    clearcoat_normal_fragment_begin: Xh,
    clearcoat_normal_fragment_maps: Yh,
    clearcoat_pars_fragment: qh,
    iridescence_pars_fragment: Zh,
    opaque_fragment: Kh,
    packing: jh,
    premultiplied_alpha_fragment: $h,
    project_vertex: Jh,
    dithering_fragment: Qh,
    dithering_pars_fragment: tu,
  ...
  et = {
    common: {
      ...
      opacity: { value: 1 },
      map: { value: null },
      mapTransform: { value: new Ct() },
      alphaMap: { value: null },
      alphaMapTransform: { value: new Ct() },
      alphaTest: { value: 0 },
    },
    specularmap: {
      specularMap: { value: null },
      specularMapTransform: { value: new Ct() },
    },
    envmap: {
      envMap: { value: null },
      envMapRotation: { value: new Ct() },
      flipEnvMap: { value: -1 },
    ...
    aomap: {
      ...
      aoMapTransform: { value: new Ct() },
    },
    lightmap: {
      lightMap: { value: null },
      lightMapIntensity: { value: 1 },
      lightMapTransform: { value: new Ct() },
    },
    bumpmap: {
      bumpMap: { value: null },
      bumpMapTransform: { value: new Ct() },
      bumpScale: { value: 1 },
    },
    normalmap: {
      normalMap: { value: null },
      normalMapTransform: { value: new Ct() },
      normalScale: { value: new Lt(1, 1) },
    },
    displacementmap: {
      displacementMap: { value: null },
      displacementMapTransform: { value: new Ct() },
      displacementScale: { value: 1 },
      displacementBias: { value: 0 },
    },
    emissivemap: {
      emissiveMap: { value: null },
      emissiveMapTransform: { value: new Ct() },
    },
    metalnessmap: {
      metalnessMap: { value: null },
      metalnessMapTransform: { value: new Ct() },
    },
    roughnessmap: {
      roughnessMap: { value: null },
      roughnessMapTransform: { value: new Ct() },
    },
  ...
  Ve = {
    ...
    backgroundCube: {
      uniforms: {
        ...
        backgroundIntensity: { value: 1 },
        backgroundRotation: { value: new Ct() },
      },
...
Ve.physical = {
  uniforms: ge([
    Ve.standard.uniforms,
    {
      clearcoat: { value: 0 },
      clearcoatMap: { value: null },
      clearcoatMapTransform: { value: new Ct() },
      clearcoatNormalMap: { value: null },
      clearcoatNormalMapTransform: { value: new Ct() },
      clearcoatNormalScale: { value: new Lt(1, 1) },
      clearcoatRoughness: { value: 0 },
      clearcoatRoughnessMap: { value: null },
      clearcoatRoughnessMapTransform: { value: new Ct() },
      dispersion: { value: 0 },
      iridescence: { value: 0 },
      iridescenceMap: { value: null },
      iridescenceMapTransform: { value: new Ct() },
      iridescenceIOR: { value: 1.3 },
      iridescenceThicknessMinimum: { value: 100 },
      iridescenceThicknessMaximum: { value: 400 },
      iridescenceThicknessMap: { value: null },
      iridescenceThicknessMapTransform: { value: new Ct() },
      sheen: { value: 0 },
      sheenColor: { value: new Kt(0) },
      sheenColorMap: { value: null },
      sheenColorMapTransform: { value: new Ct() },
      sheenRoughness: { value: 1 },
      sheenRoughnessMap: { value: null },
      sheenRoughnessMapTransform: { value: new Ct() },
      transmission: { value: 0 },
      transmissionMap: { value: null },
      transmissionMapTransform: { value: new Ct() },
      transmissionSamplerSize: { value: new Lt() },
      transmissionSamplerMap: { value: null },
      thickness: { value: 0 },
      thicknessMap: { value: null },
      thicknessMapTransform: { value: new Ct() },
      attenuationDistance: { value: 0 },
      attenuationColor: { value: new Kt(0) },
      specularColor: { value: new Kt(1, 1, 1) },
      specularColorMap: { value: null },
      specularColorMapTransform: { value: new Ct() },
      specularIntensity: { value: 1 },
      specularIntensityMap: { value: null },
      specularIntensityMapTransform: { value: new Ct() },
      anisotropyVector: { value: new Lt() },
      anisotropyMap: { value: null },
      anisotropyMapTransform: { value: new Ct() },
    },
  ]),
  vertexShader: Dt.meshphysical_vert,
  fragmentShader: Dt.meshphysical_frag,
...
function nd(i, t, e, n, r, s, a) {
  ...
  function v(y) {
    ...
    return (
      T && T.isTexture && (T = (y.backgroundBlurriness > 0 ? e : t).get(T)), T
    );
  }
  function M(y) {
    let T = !1;
    const U = v(y);
    U === null ? h(o, l) : U && U.isColor && (h(U, 1), (T = !0));
  ...
  function p(y, T) {
    const U = v(T);
    U && (U.isCubeTexture || U.mapping === ur)
      ? (u === void 0 &&
          ((u = new We(
            new pi(1, 1, 1),
            new gn({
              name: 'BackgroundCubeMaterial',
              uniforms: fi(Ve.backgroundCube.uniforms),
              vertexShader: Ve.backgroundCube.vertexShader,
              fragmentShader: Ve.backgroundCube.fragmentShader,
              side: Ee,
              depthTest: !1,
              depthWrite: !1,
              fog: !1,
          ...
          (u.onBeforeRender = function (D, R, I) {
        ...
        u.material.uniforms.backgroundRotation.value.setFromMatrix4(
          ed.makeRotationFromEuler(bn)
        ),
        (u.material.toneMapped = Gt.getTransfer(U.colorSpace) !== qt),
        (d !== U || f !== U.version || m !== i.toneMapping) &&
      ...
      : U &&
        ...
        (c === void 0 &&
          ((c = new We(
            ...
            new gn({
              ...
              uniforms: fi(Ve.background.uniforms),
              vertexShader: Ve.background.vertexShader,
              fragmentShader: Ve.background.fragmentShader,
              side: _n,
              depthTest: !1,
              depthWrite: !1,
              fog: !1,
        ...
        (c.material.toneMapped = Gt.getTransfer(U.colorSpace) !== qt),
  ...
  function h(y, T) {
    y.getRGB(Ji, To(i)), n.buffers.color.setClear(Ji.r, Ji.g, Ji.b, T, a);
  }
  function A() {
...
function id(i, t) {
  ...
  function d(x, w, k) {
    ...
    K === void 0 && ((K = {}), (Z[w.id] = K));
    let X = K[z];
    return X === void 0 && ((X = f(l())), (K[z] = X)), X;
  }
  function f(x) {
    const w = [],
      k = [],
      z = [];
    for (let Z = 0; Z < e; Z++) (w[Z] = 0), (k[Z] = 0), (z[Z] = 0);
    return {
      geometry: null,
      program: null,
      wireframe: !1,
        ...
        if (
          (vt === void 0 &&
            (V === 'instanceMatrix' &&
              x.instanceMatrix &&
              (vt = x.instanceMatrix),
            V === 'instanceColor' && x.instanceColor && (vt = x.instanceColor)),
          ht === void 0 || ht.attribute !== vt || (vt && ht.data !== vt.data))
        )
          return !0;
        X++;
      }
  ...
  function v(x, w, k, z) {
    ...
    for (const V in $)
      if ($[V].location >= 0) {
        ...
        const vt = {};
        (vt.attribute = ht),
          ht && ht.data && (vt.data = ht.data),
          (Z[V] = vt),
          X++;
      }
    (s.attributes = Z), (s.attributesNum = X), (s.index = z);
  }
  function M() {
    const x = s.newAttributes;
    for (let w = 0, k = x.length; w < k; w++) x[w] = 0;
  }
  function p(x) {
    h(x, 0);
  }
  function h(x, w) {
    ...
    (k[x] = 1),
      z[x] === 0 && (i.enableVertexAttribArray(x), (z[x] = 1)),
      Z[x] !== w && (i.vertexAttribDivisor(x, w), (Z[x] = w));
  }
  function A() {
    const x = s.newAttributes,
  ...
  function y(x, w, k, z, Z, K, X) {
    X === !0
      ? i.vertexAttribIPointer(x, w, k, Z, K)
      : i.vertexAttribPointer(x, w, k, z, Z, K);
  }
  function T(x, w, k, z) {
    M();
    const Z = z.attributes,
      K = k.getAttributes(),
        ...
        if (
          (rt === void 0 &&
            ($ === 'instanceMatrix' &&
              x.instanceMatrix &&
              (rt = x.instanceMatrix),
            $ === 'instanceColor' && x.instanceColor && (rt = x.instanceColor)),
          rt !== void 0)
        ) {
          ...
          const jt = Ut.buffer,
            W = Ut.type,
            tt = Ut.bytesPerElement,
            mt = W === i.INT || W === i.UNSIGNED_INT || rt.gpuType === Ns;
          if (rt.isInterleavedBufferAttribute) {
            const st = rt.data,
              Et = st.stride,
              kt = rt.offset;
            if (st.isInstancedInterleavedBuffer) {
              for (let yt = 0; yt < V.locationSize; yt++)
                h(V.location + yt, st.meshPerAttribute);
              x.isInstancedMesh !== !0 &&
                z._maxInstanceCount === void 0 &&
                (z._maxInstanceCount = st.meshPerAttribute * st.count);
            } else
              for (let yt = 0; yt < V.locationSize; yt++) p(V.location + yt);
  ...
  function U() {
    ...
    for (const x in n) {
      ...
      for (const k in w) {
        const z = w[k];
        for (const Z in z) u(z[Z].object), delete z[Z];
        delete w[k];
      }
      delete n[x];
    }
  ...
  (this.uniform = l),
    ...
    (this.setState = function (d, f, m) {
      ...
      if (!r || v === null || v.length === 0 || (s && !p)) s ? u(null) : c();
        ...
        (l.value = T), (T = u(v, f, y, m));
        for (let U = 0; U !== y; ++U) T[U] = e[U];
        (h.clippingState = T),
...
function od(i) {
  let t = new WeakMap();
  function e(a, o) {
    return o === ns ? (a.mapping = li) : o === is && (a.mapping = ci), a;
  }
  function n(a) {
    if (a && a.isTexture) {
      const o = a.mapping;
...
const ni = 4,
  Ca = [0.125, 0.215, 0.35, 0.446, 0.526, 0.582],
  Pn = 20,
  Hr = new _c(),
  Pa = new Kt();
let Vr = null,
...
class La {
  ...
  fromScene(t, e = 0, n = 0.1, r = 100, s = {}) {
    const { size: a = 256, position: o = ld } = s;
    (Vr = this._renderer.getRenderTarget()),
      (Gr = this._renderer.getActiveCubeFace()),
      (kr = this._renderer.getActiveMipmapLevel()),
      (Wr = this._renderer.xr.enabled),
  ...
  _cleanup(t) {
    this._renderer.setRenderTarget(Vr, Gr, kr),
      (this._renderer.xr.enabled = Wr),
      (t.scissorTest = !1),
      Qi(t, 0, 0, t.width, t.height);
  }
  _fromTexture(t, e) {
    t.mapping === li || t.mapping === ci
      ? this._setSize(
  ...
  _allocateTargets() {
    ...
    if (
      ...
      this._pingPongRenderTarget !== null && this._dispose(),
        (this._pingPongRenderTarget = Ua(t, e, n));
  ...
  _sceneToCubeUV(t, e, n, r, s) {
    const l = new Ue(90, 1, e, n),
      ...
      f = d.autoClear,
      m = d.toneMapping;
    d.getClearColor(Pa), (d.toneMapping = mn), (d.autoClear = !1);
    const v = new ks({
    ...
    h
      ? h.isColor && (v.color.copy(h), (t.background = null), (p = !0))
      : (v.color.copy(Pa), (p = !0));
    for (let A = 0; A < 6; A++) {
      const y = A % 3;
      y === 0
  ...
  _textureToCubeUV(t, e) {
    const n = this._renderer,
      r = t.mapping === li || t.mapping === ci;
    r
      ? (this._cubemapMaterial === null && (this._cubemapMaterial = Na()),
        (this._cubemapMaterial.uniforms.flipEnvMap.value =
          t.isRenderTargetTexture === !1 ? -1 : 1))
      : this._equirectMaterial === null && (this._equirectMaterial = Ia());
    const s = r ? this._cubemapMaterial : this._equirectMaterial,
      a = new We(this._lodPlanes[0], s),
      o = s.uniforms;
    o.envMap.value = t;
    const l = this._cubeSize;
    Qi(e, 0, 0, 3 * l, 2 * l), n.setRenderTarget(e), n.render(a, Hr);
  }
  _applyPMREM(t) {
  ...
  _halfBlur(t, e, n, r, s, a, o) {
    ...
    const T = this._sizeLods[r],
      U = 3 * T * (r > y - ni ? r - y + ni : 0),
      D = 4 * (this._cubeSize - T);
    Qi(e, U, D, 3 * T, 2 * T), l.setRenderTarget(e), l.render(d, Hr);
  }
}
function cd(i) {
  const t = [],
    ...
    n = [];
  let r = i;
  const s = i - ni + 1 + Ca.length;
  for (let a = 0; a < s; a++) {
    const o = Math.pow(2, r);
    e.push(o);
    let l = 1 / o;
    a > i - ni ? (l = Ca[a - i + ni - 1]) : a === 0 && (l = 0), n.push(l);
    const c = 1 / (o - 2),
      u = -c,
      d = 1 + c,
    ...
    for (let D = 0; D < m; D++) {
      ...
      A.set(S, M * v * D), y.set(f, p * v * D);
      const x = [D, D, D, D, D, D];
      T.set(x, h * v * D);
    }
    const U = new Bn();
    U.setAttribute('position', new Xe(A, M)),
      U.setAttribute('uv', new Xe(y, p)),
      U.setAttribute('faceIndex', new Xe(T, h)),
      t.push(U),
      r > ni && r--;
  }
...
function dd(i) {
  ...
  return {
    ...
    get: function (n) {
      ...
      return (
        r === null &&
          Rn('THREE.WebGLRenderer: ' + n + ' extension not supported.'),
        r
      );
    },
  };
...
function _d(i, t, e) {
  ...
  function s(a, o, l) {
    ...
    if (f === void 0 || f.count !== d) {
      ...
      let T = 0;
      v === !0 && (T = 1), M === !0 && (T = 2), p === !0 && (T = 3);
      let U = o.attributes.position.count * T,
        D = 1;
      U > t.maxTextureSize &&
        ((D = Math.ceil(U / t.maxTextureSize)), (U = t.maxTextureSize));
      const R = new Float32Array(U * D * 4 * d),
        I = new go(R, U, D, d);
      (I.type = tn), (I.needsUpdate = !0);
      const S = T * 4;
      for (let w = 0; w < d; w++) {
        const k = h[w],
          z = A[w],
        ...
        for (let X = 0; X < k.count; X++) {
          ...
          v === !0 &&
            ...
            p === !0 &&
              ...
              (R[K + $ + 9] = r.y),
              (R[K + $ + 10] = r.z),
              (R[K + $ + 11] = Z.itemSize === 4 ? r.w : 1));
        }
      }
      (f = { count: d, texture: I, size: new Lt(U, D) }),
        n.set(o, f),
...
function mi(i, t, e) {
  ...
  const r = t * e;
  let s = Oa[r];
  if ((s === void 0 && ((s = new Float32Array(r)), (Oa[r] = s)), t !== 0)) {
    n.toArray(s, 0);
...
function pr(i, t) {
  let e = Ba[t];
  e === void 0 && ((e = new Int32Array(t)), (Ba[t] = e));
...
function Ed(i, t) {
  ...
  if (n === void 0) {
    ...
    if (ce(e, n)) return;
    Va.set(n), i.uniformMatrix2fv(this.addr, !1, Va), he(e, n);
  }
}
function Td(i, t) {
  const e = this.cache,
  ...
  if (n === void 0) {
    ...
    if (ce(e, n)) return;
    Ha.set(n), i.uniformMatrix3fv(this.addr, !1, Ha), he(e, n);
  }
}
function yd(i, t) {
  const e = this.cache,
...
function Id(i, t, e) {
  const n = this.cache,
    r = e.allocateTextureUnit();
  n[0] !== r && (i.uniform1i(this.addr, r), (n[0] = r)),
    e.setTexture3D(t || Lo, r);
}
function Nd(i, t, e) {
  const n = this.cache,
    r = e.allocateTextureUnit();
  n[0] !== r && (i.uniform1i(this.addr, r), (n[0] = r)),
    e.setTextureCube(t || Uo, r);
}
function Fd(i, t, e) {
  const n = this.cache,
    r = e.allocateTextureUnit();
  n[0] !== r && (i.uniform1i(this.addr, r), (n[0] = r)),
    e.setTexture2DArray(t || Do, r);
}
function Od(i) {
  switch (i) {
    case 5126:
...
function Qd(i, t, e) {
  ...
  for (let a = 0; a !== r; ++a) e.setTexture2D(t[a] || Po, s[a]);
}
function tf(i, t, e) {
  const n = this.cache,
    r = t.length,
    s = pr(e, r);
  ce(n, s) || (i.uniform1iv(this.addr, s), he(n, s));
  for (let a = 0; a !== r; ++a) e.setTexture3D(t[a] || Lo, s[a]);
}
function ef(i, t, e) {
  const n = this.cache,
    r = t.length,
    s = pr(e, r);
  ce(n, s) || (i.uniform1iv(this.addr, s), he(n, s));
  for (let a = 0; a !== r; ++a) e.setTextureCube(t[a] || Uo, s[a]);
}
function nf(i, t, e) {
  const n = this.cache,
    r = t.length,
    s = pr(e, r);
  ce(n, s) || (i.uniform1iv(this.addr, s), he(n, s));
  for (let a = 0; a !== r; ++a) e.setTexture2DArray(t[a] || Do, s[a]);
}
function rf(i) {
  switch (i) {
    case 5126:
...
function lf(i, t, e) {
  ...
  for (Xr.lastIndex = 0; ; ) {
    ...
    if ((l && (o = o | 0), c === void 0 || (c === '[' && a + 2 === r))) {
      Ga(e, c === void 0 ? new sf(o, i, t) : new af(o, i, t));
      break;
    } else {
      let d = e.map[o];
      d === void 0 && ((d = new of(o)), Ga(e, d)), (e = d);
    }
  }
}
class lr {
...
const Wa = new Ct();
function df(i) {
  Gt._getMatrix(Wa, Gt.workingColorSpace, i);
  const t = `mat3( ${Wa.elements.map((e) => e.toFixed(4))} )`;
...
const tr = new F();
function mf() {
  Gt.getLuminanceCoefficients(tr);
  const i = tr.x.toFixed(4),
    t = tr.y.toFixed(4),
    e = tr.z.toFixed(4);
  return [
...
function yf(i) {
  ...
  return (
    i.shadowMapType === eo
      ...
      : i.shadowMapType === Je && (t = 'SHADOWMAP_TYPE_VSM'),
    t
  );
}
function bf(i) {
...
`)),
      (h = [
        ...
        e.toneMapping !== mn ? Dt.tonemapping_pars_fragment : '',
        e.toneMapping !== mn ? pf('toneMapping', e.toneMapping) : '',
...
` +
  ...
  const y = A + p + a,
    T = A + h + o,
    U = ka(r, r.VERTEX_SHADER, y),
    D = ka(r, r.FRAGMENT_SHADER, T);
  r.attachShader(M, U),
    r.attachShader(M, D),
...
` +
      ...
      X &&
        (w.diagnostics = {
          runnable: K,
          programLog: k,
          vertexShader: { log: z, prefix: p },
          fragmentShader: { log: Z, prefix: h },
        });
    }
    r.deleteShader(U), r.deleteShader(D), (I = new lr(r, M)), (S = vf(r, M));
  }
  let I;
  ...
  return (
    (this.isReady = function () {
      return x === !1 && (x = r.getProgramParameter(M, cf)), x;
    }),
...
class Df {
  ...
  _getShaderStage(t) {
    ...
    let n = e.get(t);
    return n === void 0 && ((n = new Lf(t)), e.set(t, n)), n;
  }
}
class Lf {
  constructor(t) {
    (this.id = Pf++), (this.code = t), (this.usedTimes = 0);
  }
}
function Uf(i, t, e, n, r, s, a) {
  const o = new xo(),
    l = new Df(),
    c = new Set(),
    u = [],
  ...
  function p(S, x, w, k, z) {
    const Z = k.fog,
      K = z.geometry,
      X = S.isMeshStandardMaterial ? k.environment : null,
      $ = (S.isMeshStandardMaterial ? e : t).get(S.envMap || X),
      V = $ && $.mapping === ur ? $.image.height : null,
      rt = v[S.type];
    S.precision !== null &&
    ...
    const ht =
      ...
      vt = ht !== void 0 ? ht.length : 0;
    let Ut = 0;
    K.morphAttributes.position !== void 0 && (Ut = 1),
      K.morphAttributes.normal !== void 0 && (Ut = 2),
      K.morphAttributes.color !== void 0 && (Ut = 3);
    let jt, W, tt, mt;
    if (rt) {
      const Yt = Ve[rt];
      (jt = Yt.vertexShader), (W = Yt.fragmentShader);
    } else
      (jt = S.vertexShader),
        (W = S.fragmentShader),
        l.update(S),
        (tt = l.getVertexShaderID(S)),
        (mt = l.getFragmentShaderID(S));
    const st = i.getRenderTarget(),
      Et = i.state.buffers.depth.getReversed(),
      kt = z.isInstancedMesh === !0,
      yt = z.isBatchedMesh === !0,
      ie = !!S.map,
      te = !!S.matcap,
      Nt = !!$,
      b = !!S.aoMap,
      ...
      G = S.sheen > 0,
      _t = S.transmission > 0,
      at = _ && !!S.anisotropyMap,
      ut = N && !!S.clearcoatMap,
      zt = N && !!S.clearcoatNormalMap,
      Q = N && !!S.clearcoatRoughnessMap,
      dt = j && !!S.iridescenceMap,
      Tt = j && !!S.iridescenceThicknessMap,
      bt = G && !!S.sheenColorMap,
      ft = G && !!S.sheenRoughnessMap,
      Bt = !!S.specularMap,
      Pt = !!S.specularColorMap,
      $t = !!S.specularIntensityMap,
      C = _t && !!S.transmissionMap,
      nt = _t && !!S.thicknessMap,
      H = !!S.gradientMap,
      q = !!S.alphaMap,
      lt = S.alphaTest > 0,
      ot = !!S.alphaHash,
    ...
    const fe = {
      ...
      precision: m,
      batching: yt,
      batchingColor: yt && z._colorsTexture !== null,
      instancing: kt,
      ...
      outputColorSpace:
        st === null
          ? i.outputColorSpace
          : st.isXRRenderTarget === !0
          ? st.texture.colorSpace
          : di,
      alphaToCoverage: !!S.alphaToCoverage,
      map: ie,
      matcap: te,
      envMap: Nt,
      envMapMode: Nt && $.mapping,
      ...
      emissiveMap: Jt,
      normalMapObjectSpace: Ot && S.normalMapType === yl,
      normalMapTangentSpace: Ot && S.normalMapType === Tl,
      metalnessMap: gt,
      roughnessMap: E,
      anisotropy: _,
      anisotropyMap: at,
      ...
      gradientMap: H,
      opaque:
        S.transparent === !1 && S.blending === ri && S.alphaToCoverage === !1,
      alphaMap: q,
      alphaTest: lt,
      alphaHash: ot,
      combine: S.combine,
      mapUv: ie && M(S.map.channel),
      aoMapUv: b && M(S.aoMap.channel),
      lightMapUv: Ce && M(S.lightMap.channel),
      bumpMapUv: Ft && M(S.bumpMap.channel),
      normalMapUv: Ot && M(S.normalMap.channel),
      displacementMapUv: xt && M(S.displacementMap.channel),
      emissiveMapUv: Jt && M(S.emissiveMap.channel),
      metalnessMapUv: gt && M(S.metalnessMap.channel),
      roughnessMapUv: E && M(S.roughnessMap.channel),
      anisotropyMapUv: at && M(S.anisotropyMap.channel),
      clearcoatMapUv: ut && M(S.clearcoatMap.channel),
      clearcoatNormalMapUv: zt && M(S.clearcoatNormalMap.channel),
      clearcoatRoughnessMapUv: Q && M(S.clearcoatRoughnessMap.channel),
      iridescenceMapUv: dt && M(S.iridescenceMap.channel),
      iridescenceThicknessMapUv: Tt && M(S.iridescenceThicknessMap.channel),
      sheenColorMapUv: bt && M(S.sheenColorMap.channel),
      sheenRoughnessMapUv: ft && M(S.sheenRoughnessMap.channel),
      specularMapUv: Bt && M(S.specularMap.channel),
      specularColorMapUv: Pt && M(S.specularColorMap.channel),
      specularIntensityMapUv: $t && M(S.specularIntensityMap.channel),
      transmissionMapUv: C && M(S.transmissionMap.channel),
      thicknessMapUv: nt && M(S.thicknessMap.channel),
      alphaMapUv: q && M(S.alphaMap.channel),
      vertexTangents: !!K.attributes.tangent && (Ot || _),
      vertexColors: S.vertexColors,
      vertexAlphas:
        S.vertexColors === !0 &&
        !!K.attributes.color &&
        K.attributes.color.itemSize === 4,
      pointsUvs: z.isPoints === !0 && !!K.attributes.uv && (ie || q),
      fog: !!Z,
      useFog: S.fog === !0,
      ...
      decodeVideoTexture:
        ...
        Gt.getTransfer(S.map.colorSpace) === qt,
      decodeVideoTextureEmissive:
        Jt &&
        S.emissiveMap.isVideoTexture === !0 &&
        Gt.getTransfer(S.emissiveMap.colorSpace) === qt,
      premultipliedAlpha: S.premultipliedAlpha,
      doubleSided: S.side === Qe,
      flipSided: S.side === Ee,
      ...
      extensionMultiDraw:
        ((wt && S.extensions.multiDraw === !0) || yt) &&
  ...
  function h(S) {
    ...
    if (
      ...
      for (const w in S.defines) x.push(w), x.push(S.defines[w]);
    return (
      S.isRawShaderMaterial === !1 &&
        (A(x, S), y(x, S), x.push(i.outputColorSpace)),
  ...
  function U(S, x) {
    ...
    return w === void 0 && ((w = new Cf(i, x, S, s)), u.push(w)), w;
  }
  function D(S) {
    if (--S.usedTimes === 0) {
      const x = u.indexOf(S);
    ...
    get: function (t) {
      ...
      switch (t.type) {
        case 'DirectionalLight':
          e = { direction: new F(), color: new Kt() };
          break;
        case 'SpotLight':
          e = {
            position: new F(),
          ...
          break;
        case 'PointLight':
          e = { position: new F(), color: new Kt(), distance: 0, decay: 0 };
          break;
        case 'HemisphereLight':
          e = { direction: new F(), skyColor: new Kt(), groundColor: new Kt() };
          break;
        case 'RectAreaLight':
          e = {
            color: new Kt(),
...
function Vf(i) {
  ...
  function o(c) {
    ...
    for (let S = 0, x = c.length; S < x; S++) {
      ...
      if (w.isAmbientLight) (u += k.r * z), (d += k.g * z), (f += k.b * z);
      else if (w.isLightProbe) {
        for (let X = 0; X < 9; X++)
          n.probe[X].addScaledVector(w.sh.coefficients[X], z);
        R++;
      } else if (w.isDirectionalLight) {
        const X = t.get(w);
        if ((X.color.copy(w.color).multiplyScalar(w.intensity), w.castShadow)) {
          const $ = w.shadow,
            V = e.get(w);
        ...
        const X = t.get(w);
        X.position.setFromMatrixPosition(w.matrixWorld),
          X.color.copy(k).multiplyScalar(z),
          (X.distance = Z),
          (X.coneCos = Math.cos(w.angle)),
          (X.penumbraCos = Math.cos(w.angle * (1 - w.penumbra))),
          (X.decay = w.decay),
          (n.spot[M] = X);
        const $ = w.shadow;
        if (
          (w.map &&
            ((n.spotLightMap[U] = w.map),
            U++,
            $.updateMatrices(w),
            w.castShadow && D++),
        ...
        const X = t.get(w);
        X.color.copy(k).multiplyScalar(z),
          X.halfWidth.set(w.width * 0.5, 0, 0),
          X.halfHeight.set(0, w.height * 0.5, 0),
          (n.rectArea[p] = X),
          p++;
      } else if (w.isPointLight) {
        const X = t.get(w);
        if (
          (X.color.copy(w.color).multiplyScalar(w.intensity),
          (X.distance = w.distance),
          (X.decay = w.decay),
          w.castShadow)
        ) {
          const $ = w.shadow,
          ...
          (V.shadowIntensity = $.intensity),
            ...
            (n.pointShadowMatrix[v] = w.shadow.matrix),
            y++;
        }
        (n.point[v] = X), v++;
      } else if (w.isHemisphereLight) {
        const X = t.get(w);
        X.skyColor.copy(w.color).multiplyScalar(z),
          X.groundColor.copy(w.groundColor).multiplyScalar(z),
          (n.hemi[h] = X),
          h++;
      }
    }
    ...
    (I.directionalLength !== m ||
      ...
      (n.spotLightMatrix.length = T + U - D),
      (n.spotLightMap.length = U),
      (n.numSpotLightShadowsWithMaps = D),
      (n.numLightProbes = R),
      (I.directionalLength = m),
      (I.pointLength = v),
      (I.spotLength = M),
...
function Xf(i, t, e) {
  ...
  this.render = function (D, R, I) {
    ...
    for (let K = 0, X = D.length; K < X; K++) {
      ...
      if (
        ...
        (r.x > u || r.y > u) &&
          (r.x > u &&
            ((s.x = Math.floor(u / rt.x)),
            (r.x = s.x * rt.x),
            (V.mapSize.x = s.x)),
          r.y > u &&
            ((s.y = Math.floor(u / rt.y)),
            (r.y = s.y * rt.y),
            (V.mapSize.y = s.y))),
        V.map === null || z === !0 || Z === !0)
      ) {
        const vt = this.type !== Je ? { minFilter: Re, magFilter: Re } : {};
        V.map !== null && V.map.dispose(),
          (V.map = new Nn(r.x, r.y, vt)),
      ...
      for (let vt = 0; vt < ht; vt++) {
        ...
        a.set(s.x * Ut.x, s.y * Ut.y, s.x * Ut.z, s.y * Ut.w),
          k.viewport(a),
          V.updateMatrices($, vt),
          (n = V.getFrustum()),
          T(R, I, V.camera, $, this.type);
      }
      V.isPointLightShadow !== !0 && this.type === Je && A(V, I),
        (V.needsUpdate = !1);
    }
  ...
  function A(D, R) {
    const I = t.update(M);
    f.defines.VSM_SAMPLES !== D.blurSamples &&
      ((f.defines.VSM_SAMPLES = D.blurSamples),
      (m.defines.VSM_SAMPLES = D.blurSamples),
      (f.needsUpdate = !0),
      (m.needsUpdate = !0)),
      D.mapPass === null && (D.mapPass = new Nn(r.x, r.y)),
      (f.uniforms.shadow_pass.value = D.map.texture),
      (f.uniforms.resolution.value = D.mapSize),
      (f.uniforms.radius.value = D.radius),
      i.setRenderTarget(D.mapPass),
      i.clear(),
      i.renderBufferDirect(R, null, I, f, M, null),
      (m.uniforms.shadow_pass.value = D.mapPass.texture),
      (m.uniforms.resolution.value = D.mapSize),
      (m.uniforms.radius.value = D.radius),
      i.setRenderTarget(D.map),
      i.clear(),
      i.renderBufferDirect(R, null, I, m, M, null);
  }
  function y(D, R, I, S) {
    let x = null;
    const w =
      I.isPointLight === !0 ? D.customDistanceMaterial : D.customDepthMaterial;
    if (w !== void 0) x = w;
    else if (
      ((x = I.isPointLight === !0 ? l : o),
      ...
      let K = Z[z];
      K === void 0 &&
        ((K = x.clone()), (Z[z] = K), R.addEventListener('dispose', U)),
        (x = K);
    }
    if (
      ((x.visible = R.visible),
      ...
      S === Je
        ? (x.side = R.shadowSide !== null ? R.shadowSide : R.side)
        : (x.side = R.shadowSide !== null ? R.shadowSide : d[R.side]),
  ...
  function T(D, R, I, S, x) {
    if (D.visible === !1) return;
    if (
      D.layers.test(R.layers) &&
      (D.isMesh || D.isLine || D.isPoints) &&
      (D.castShadow || (D.receiveShadow && x === Je)) &&
      (!D.frustumCulled || n.intersectsObject(D))
    ) {
      ...
      if (Array.isArray(Z)) {
        ...
        for (let X = 0, $ = K.length; X < $; X++) {
          ...
          if (rt && rt.visible) {
            const ht = y(D, rt, S, x);
            D.onBeforeShadow(i, D, R, I, z, ht, V),
              i.renderBufferDirect(I, null, z, ht, D, V),
              D.onAfterShadow(i, D, R, I, z, ht, V);
          }
        }
      } else if (Z.visible) {
        const K = y(D, Z, S, x);
        D.onBeforeShadow(i, D, R, I, z, K, null),
          i.renderBufferDirect(I, null, z, K, D, null),
          D.onAfterShadow(i, D, R, I, z, K, null);
      }
    }
    const k = D.children;
    for (let z = 0, Z = k.length; z < Z; z++) T(k[z], R, I, S, x);
  }
  function U(D) {
...
function qf(i, t) {
  function e() {
    ...
    return {
      ...
      setClear: function (lt, ot, wt, ee, fe) {
        fe === !0 && ((lt *= ee), (ot *= ee), (wt *= ee)),
          nt.set(lt, ot, wt, ee),
          q.equals(nt) === !1 && (i.clearColor(lt, ot, wt, ee), q.copy(nt));
      },
      reset: function () {
        (C = !1), (H = null), q.set(-1, 0, 0, 0);
      },
    };
  }
  function n() {
    ...
    return {
      ...
      setTest: function (ot) {
        ot ? st(i.DEPTH_TEST) : Et(i.DEPTH_TEST);
      },
      setMask: function (ot) {
      ...
      reset: function () {
        (C = !1), (H = null), (q = null), (lt = null), (nt = !1);
      },
    };
  }
  function r() {
    ...
    return {
      setTest: function (Yt) {
        C || (Yt ? st(i.STENCIL_TEST) : Et(i.STENCIL_TEST));
      },
      setMask: function (Yt) {
        nt !== Yt && !C && (i.stencilMask(Yt), (nt = Yt));
      },
      setFunc: function (Yt, Ie, Ye) {
        (H !== Yt || q !== Ie || lt !== Ye) &&
          (i.stencilFunc(Yt, Ie, Ye), (H = Yt), (q = Ie), (lt = Ye));
      },
      setOp: function (Yt, Ie, Ye) {
        (ot !== Yt || wt !== Ie || ee !== Ye) &&
          (i.stencilOp(Yt, Ie, Ye), (ot = Yt), (wt = Ie), (ee = Ye));
      },
  ...
  V.indexOf('WebGL') !== -1
    ? (($ = parseFloat(/^WebGL (\d)/.exec(V)[1])), (X = $ >= 1))
    : V.indexOf('OpenGL ES') !== -1 &&
      (($ = parseFloat(/^OpenGL ES (\d)/.exec(V)[1])), (X = $ >= 2));
  let rt = null,
    ht = {};
  const vt = i.getParameter(i.SCISSOR_BOX),
    Ut = i.getParameter(i.VIEWPORT),
    jt = new re().fromArray(vt),
    W = new re().fromArray(Ut);
  function tt(C, nt, H, q) {
    ...
    for (let wt = 0; wt < H; wt++)
      C === i.TEXTURE_3D || C === i.TEXTURE_2D_ARRAY
        ? i.texImage3D(nt, 0, i.RGBA, 1, 1, q, 0, i.RGBA, i.UNSIGNED_BYTE, lt)
        : i.texImage2D(
            nt + wt,
            0,
            i.RGBA,
  ...
  function kt(C, nt) {
    return d[C] !== nt
      ? (i.bindFramebuffer(C, nt),
        (d[C] = nt),
        C === i.DRAW_FRAMEBUFFER && (d[i.FRAMEBUFFER] = nt),
        C === i.FRAMEBUFFER && (d[i.DRAW_FRAMEBUFFER] = nt),
        !0)
      : !1;
  }
  function yt(C, nt) {
    ...
    if (C) {
      ...
      if (H.length !== lt.length || H[0] !== i.COLOR_ATTACHMENT0) {
        for (let ot = 0, wt = lt.length; ot < wt; ot++)
          H[ot] = i.COLOR_ATTACHMENT0 + ot;
        (H.length = lt.length), (q = !0);
      }
    } else H[0] !== i.BACK && ((H[0] = i.BACK), (q = !0));
    q && i.drawBuffers(H);
  }
  function ie(C) {
  ...
  (te[jo] = i.MIN), (te[$o] = i.MAX);
  const Nt = {
    [Jo]: i.ZERO,
    [Qo]: i.ONE,
    [tl]: i.SRC_COLOR,
    [qr]: i.SRC_ALPHA,
    [al]: i.SRC_ALPHA_SATURATE,
    [rl]: i.DST_COLOR,
    [nl]: i.DST_ALPHA,
    [el]: i.ONE_MINUS_SRC_COLOR,
    [Zr]: i.ONE_MINUS_SRC_ALPHA,
    [sl]: i.ONE_MINUS_DST_COLOR,
    [il]: i.ONE_MINUS_DST_ALPHA,
    [ol]: i.CONSTANT_COLOR,
    [ll]: i.ONE_MINUS_CONSTANT_COLOR,
    [cl]: i.CONSTANT_ALPHA,
    [hl]: i.ONE_MINUS_CONSTANT_ALPHA,
  };
  function b(C, nt, H, q, lt, ot, wt, ee, fe, Yt) {
    if (C === pn) {
      M === !0 && (Et(i.BLEND), (M = !1));
      return;
    }
    if ((M === !1 && (st(i.BLEND), (M = !0)), C !== qo)) {
      if (C !== p || Yt !== S) {
        if (
          ((h !== Cn || T !== Cn) &&
            (i.blendEquation(i.FUNC_ADD), (h = Cn), (T = Cn)),
          Yt)
        )
          switch (C) {
            case ri:
    ...
    (lt = lt || nt),
      ...
      (wt = wt || q),
      (nt !== h || lt !== T) &&
        (i.blendEquationSeparate(te[nt], te[lt]), (h = nt), (T = lt)),
      (H !== A || q !== y || ot !== U || wt !== D) &&
        (i.blendFuncSeparate(Nt[H], Nt[q], Nt[ot], Nt[wt]),
        (A = H),
        (y = q),
        (U = ot),
        (D = wt)),
      (ee.equals(R) === !1 || fe !== I) &&
        (i.blendColor(ee.r, ee.g, ee.b, fe), R.copy(ee), (I = fe)),
      (p = C),
      (S = !1);
  }
  function Ce(C, nt) {
    C.side === Qe ? Et(i.CULL_FACE) : st(i.CULL_FACE);
    let H = C.side === Ee;
    nt && (H = !H),
      Ft(H),
    ...
    o.setTest(q),
      ...
      Jt(C.polygonOffset, C.polygonOffsetFactor, C.polygonOffsetUnits),
      C.alphaToCoverage === !0
        ? st(i.SAMPLE_ALPHA_TO_COVERAGE)
        : Et(i.SAMPLE_ALPHA_TO_COVERAGE);
  }
  function Ft(C) {
  ...
  function Jt(C, nt, H) {
    C
      ? (st(i.POLYGON_OFFSET_FILL),
        (z !== nt || Z !== H) && (i.polygonOffset(nt, H), (z = nt), (Z = H)))
      : Et(i.POLYGON_OFFSET_FILL);
  }
  function gt(C) {
    C ? st(i.SCISSOR_TEST) : Et(i.SCISSOR_TEST);
  }
  function E(C) {
    C === void 0 && (C = i.TEXTURE0 + K - 1),
      rt !== C && (i.activeTexture(C), (rt = C));
  }
  function _(C, nt, H) {
    H === void 0 && (rt === null ? (H = i.TEXTURE0 + K - 1) : (H = rt));
    let q = ht[H];
    q === void 0 && ((q = { type: void 0, texture: void 0 }), (ht[H] = q)),
      (q.type !== C || q.texture !== nt) &&
        (rt !== H && (i.activeTexture(H), (rt = H)),
        i.bindTexture(C, nt || mt[C]),
        (q.type = C),
        (q.texture = nt));
  }
  function N() {
  ...
  function bt(C) {
    jt.equals(C) === !1 && (i.scissor(C.x, C.y, C.z, C.w), jt.copy(C));
  }
  function ft(C) {
    W.equals(C) === !1 && (i.viewport(C.x, C.y, C.z, C.w), W.copy(C));
  }
  function Bt(C, nt) {
    let H = c.get(nt);
    H === void 0 && ((H = new WeakMap()), c.set(nt, H));
    let q = H.get(C);
    q === void 0 && ((q = i.getUniformBlockIndex(nt, C.name)), H.set(C, q));
  }
  function Pt(C, nt) {
    const q = c.get(nt).get(C);
    l.get(nt) !== q &&
      (i.uniformBlockBinding(nt, q, C.__bindingPointIndex), l.set(nt, q));
  }
  function $t() {
    i.disable(i.BLEND),
...
function Zf(i, t, e, n, r, s, a) {
  ...
  function v(E, _) {
    return m ? new OffscreenCanvas(E, _) : yi('canvas');
  }
  function M(E, _, N) {
    let Y = 1;
    const j = gt(E);
    if (
      ((j.width > N || j.height > N) && (Y = N / Math.max(j.width, j.height)),
      Y < 1)
    )
      if (
        ...
        return (
          (at.width = G),
          (at.height = _t),
          at.getContext('2d').drawImage(E, 0, 0, G, _t),
          console.warn(
  ...
  function y(E, _, N, Y, j = !1) {
    ...
    if (
      (_ === i.RED &&
        (N === i.FLOAT && (G = i.R32F),
        N === i.HALF_FLOAT && (G = i.R16F),
        N === i.UNSIGNED_BYTE && (G = i.R8)),
      _ === i.RED_INTEGER &&
        (N === i.UNSIGNED_BYTE && (G = i.R8UI),
        N === i.UNSIGNED_SHORT && (G = i.R16UI),
        N === i.UNSIGNED_INT && (G = i.R32UI),
        N === i.BYTE && (G = i.R8I),
        N === i.SHORT && (G = i.R16I),
        N === i.INT && (G = i.R32I)),
      _ === i.RG &&
        (N === i.FLOAT && (G = i.RG32F),
        N === i.HALF_FLOAT && (G = i.RG16F),
        N === i.UNSIGNED_BYTE && (G = i.RG8)),
      _ === i.RG_INTEGER &&
        (N === i.UNSIGNED_BYTE && (G = i.RG8UI),
        N === i.UNSIGNED_SHORT && (G = i.RG16UI),
        N === i.UNSIGNED_INT && (G = i.RG32UI),
        N === i.BYTE && (G = i.RG8I),
        N === i.SHORT && (G = i.RG16I),
        N === i.INT && (G = i.RG32I)),
      _ === i.RGB_INTEGER &&
        (N === i.UNSIGNED_BYTE && (G = i.RGB8UI),
        N === i.UNSIGNED_SHORT && (G = i.RGB16UI),
        N === i.UNSIGNED_INT && (G = i.RGB32UI),
        N === i.BYTE && (G = i.RGB8I),
        N === i.SHORT && (G = i.RGB16I),
        N === i.INT && (G = i.RGB32I)),
      _ === i.RGBA_INTEGER &&
        (N === i.UNSIGNED_BYTE && (G = i.RGBA8UI),
        N === i.UNSIGNED_SHORT && (G = i.RGBA16UI),
        N === i.UNSIGNED_INT && (G = i.RGBA32UI),
        N === i.BYTE && (G = i.RGBA8I),
        N === i.SHORT && (G = i.RGBA16I),
        N === i.INT && (G = i.RGBA32I)),
      _ === i.RGB && N === i.UNSIGNED_INT_5_9_9_9_REV && (G = i.RGB9_E5),
      _ === i.RGBA)
    ) {
      const _t = j ? cr : Gt.getTransfer(Y);
      N === i.FLOAT && (G = i.RGBA32F),
        N === i.HALF_FLOAT && (G = i.RGBA16F),
        N === i.UNSIGNED_BYTE && (G = _t === qt ? i.SRGB8_ALPHA8 : i.RGBA8),
        N === i.UNSIGNED_SHORT_4_4_4_4 && (G = i.RGBA4),
        N === i.UNSIGNED_SHORT_5_5_5_1 && (G = i.RGB5_A1);
    }
    return (
      (G === i.R16F ||
        G === i.R32F ||
  ...
  function T(E, _) {
    ...
    return (
      E
        ...
        : _ === Ti && (N = i.DEPTH_COMPONENT16),
      N
    );
  }
  function U(E, _) {
    return p(E) === !0 ||
      (E.isFramebufferTexture && E.minFilter !== Re && E.minFilter !== ke)
  ...
  const rt = { [rs]: i.REPEAT, [Dn]: i.CLAMP_TO_EDGE, [ss]: i.MIRRORED_REPEAT },
    ht = {
      [Re]: i.NEAREST,
      [Ml]: i.NEAREST_MIPMAP_NEAREST,
      [Ui]: i.NEAREST_MIPMAP_LINEAR,
      [ke]: i.LINEAR,
      [gr]: i.LINEAR_MIPMAP_NEAREST,
      [Ln]: i.LINEAR_MIPMAP_LINEAR,
    },
    vt = {
      [bl]: i.NEVER,
      [Dl]: i.ALWAYS,
  ...
  function Ut(E, _) {
    if (
      ...
      i.texParameteri(E, i.TEXTURE_WRAP_S, rt[_.wrapS]),
      i.texParameteri(E, i.TEXTURE_WRAP_T, rt[_.wrapT]),
      (E === i.TEXTURE_3D || E === i.TEXTURE_2D_ARRAY) &&
        i.texParameteri(E, i.TEXTURE_WRAP_R, rt[_.wrapR]),
      i.texParameteri(E, i.TEXTURE_MAG_FILTER, ht[_.magFilter]),
      i.texParameteri(E, i.TEXTURE_MIN_FILTER, ht[_.minFilter]),
      _.compareFunction &&
        (i.texParameteri(E, i.TEXTURE_COMPARE_MODE, i.COMPARE_REF_TO_TEXTURE),
        i.texParameteri(E, i.TEXTURE_COMPARE_FUNC, vt[_.compareFunction])),
      t.has('EXT_texture_filter_anisotropic') === !0)
    ) {
      if (
        _.magFilter === Re ||
        (_.minFilter !== Ui && _.minFilter !== Ln) ||
        (_.type === tn && t.has('OES_texture_float_linear') === !1)
      )
        return;
  ...
  function jt(E, _) {
    ...
    E.__webglInit === void 0 &&
      ((E.__webglInit = !0), _.addEventListener('dispose', D));
    const Y = _.source;
    let j = f.get(Y);
    ...
    if (G !== E.__cacheKey) {
      j[G] === void 0 &&
        ((j[G] = { texture: i.createTexture(), usedTimes: 0 }),
        a.memory.textures++,
        (N = !0)),
        j[G].usedTimes++;
      const _t = j[E.__cacheKey];
      _t !== void 0 &&
        (j[E.__cacheKey].usedTimes--, _t.usedTimes === 0 && S(_)),
        (E.__cacheKey = G),
        (E.__webglTexture = j[G].texture);
    }
    return N;
  }
  function W(E, _, N) {
    ...
    const j = jt(E, _),
      G = _.source;
    e.bindTexture(Y, E.__webglTexture, i.TEXTURE0 + N);
    const _t = n.get(G);
    if (G.version !== _t.__version || j === !0) {
      e.activeTexture(i.TEXTURE0 + N);
      const at = Gt.getPrimaries(Gt.workingColorSpace),
        ut = _.colorSpace === fn ? null : Gt.getPrimaries(_.colorSpace),
        zt =
          _.colorSpace === fn || at === ut ? i.NONE : i.BROWSER_DEFAULT_WEBGL;
      ...
      const dt = s.convert(_.format, _.colorSpace),
        Tt = s.convert(_.type);
      let bt = y(_.internalFormat, dt, Tt, _.colorSpace, _.isVideoTexture);
      Ut(Y, _);
      let ft;
      const Bt = _.mipmaps,
        Pt = _.isVideoTexture !== !0,
        $t = _t.__version === void 0 || j === !0,
        C = G.dataReady,
        nt = U(_, Q);
      if (_.isDepthTexture)
        (bt = T(_.format === ui, _.type)),
          $t &&
            (Pt
              ? e.texStorage2D(i.TEXTURE_2D, 1, bt, Q.width, Q.height)
              : e.texImage2D(
                  i.TEXTURE_2D,
                  0,
                  bt,
        ...
        if (Bt.length > 0) {
          Pt &&
            $t &&
            e.texStorage2D(i.TEXTURE_2D, nt, bt, Bt[0].width, Bt[0].height);
          for (let H = 0, q = Bt.length; H < q; H++)
            (ft = Bt[H]),
              Pt
                ? C &&
                  e.texSubImage2D(
          ...
          Pt
            ? ($t && e.texStorage2D(i.TEXTURE_2D, nt, bt, Q.width, Q.height),
              C &&
                e.texSubImage2D(
                  i.TEXTURE_2D,
                  0,
        ...
        if (_.isCompressedArrayTexture) {
          ...
          for (let H = 0, q = Bt.length; H < q; H++)
            if (((ft = Bt[H]), _.format !== He))
              if (dt !== null)
                if (Pt) {
                  if (C)
                    if (_.layerUpdates.size > 0) {
                      const lt = wa(ft.width, ft.height, _.format, _.type);
                      for (const ot of _.layerUpdates) {
                        const wt = ft.data.subarray(
        ...
        if (Pt) {
          if (
            ...
            if (_.layerUpdates.size > 0) {
              const H = wa(Q.width, Q.height, _.format, _.type);
              for (const q of _.layerUpdates) {
                const lt = Q.data.subarray(
                  (q * H) / Q.data.BYTES_PER_ELEMENT,
        ...
        Pt
          ? ($t &&
              e.texStorage3D(i.TEXTURE_3D, nt, bt, Q.width, Q.height, Q.depth),
            C &&
              e.texSubImage3D(
                i.TEXTURE_3D,
                0,
        ...
        if ($t)
          if (Pt) e.texStorage2D(i.TEXTURE_2D, nt, bt, Q.width, Q.height);
          else {
            let H = Q.width,
              q = Q.height;
            for (let lt = 0; lt < nt; lt++)
              e.texImage2D(i.TEXTURE_2D, lt, bt, H, q, 0, dt, Tt, null),
                (H >>= 1),
                (q >>= 1);
          }
      } else if (Bt.length > 0) {
        ...
        for (let H = 0, q = Bt.length; H < q; H++)
          (ft = Bt[H]),
            Pt
              ? C && e.texSubImage2D(i.TEXTURE_2D, H, 0, 0, dt, Tt, ft)
              : e.texImage2D(i.TEXTURE_2D, H, bt, dt, Tt, ft);
        _.generateMipmaps = !1;
      } else if (Pt) {
        if ($t) {
          const H = gt(Q);
        ...
        C && e.texSubImage2D(i.TEXTURE_2D, 0, 0, 0, dt, Tt, Q);
      } else e.texImage2D(i.TEXTURE_2D, 0, bt, dt, Tt, Q);
      p(_) && h(Y), (_t.__version = G.version), _.onUpdate && _.onUpdate(_);
    }
  ...
  function tt(E, _, N) {
    ...
    const G = n.get(j);
    if (j.version !== G.__version || Y === !0) {
      e.activeTexture(i.TEXTURE0 + N);
      const _t = Gt.getPrimaries(Gt.workingColorSpace),
        at = _.colorSpace === fn ? null : Gt.getPrimaries(_.colorSpace),
        ut =
          _.colorSpace === fn || _t === at ? i.NONE : i.BROWSER_DEFAULT_WEBGL;
      i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL, _.flipY),
        i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL, _.premultiplyAlpha),
        i.pixelStorei(i.UNPACK_ALIGNMENT, _.unpackAlignment),
      ...
      for (let q = 0; q < 6; q++)
        !zt && !Q
          ? (dt[q] = M(_.image[q], !0, r.maxCubemapSize))
          : (dt[q] = Q ? _.image[q].image : _.image[q]),
          (dt[q] = Jt(_, dt[q]));
      const Tt = dt[0],
        bt = s.convert(_.format, _.colorSpace),
        ft = s.convert(_.type),
        Bt = y(_.internalFormat, bt, ft, _.colorSpace),
        Pt = _.isVideoTexture !== !0,
        $t = G.__version === void 0 || Y === !0,
        C = j.dataReady;
      let nt = U(_, Tt);
      ...
      if (zt) {
        Pt &&
          $t &&
          e.texStorage2D(i.TEXTURE_CUBE_MAP, nt, Bt, Tt.width, Tt.height);
        for (let q = 0; q < 6; q++) {
          H = dt[q].mipmaps;
      ...
      p(_) && h(i.TEXTURE_CUBE_MAP),
        (G.__version = j.version),
        _.onUpdate && _.onUpdate(_);
    }
    E.__version = _.version;
  }
  function mt(E, _, N, Y, j, G) {
    const _t = s.convert(N.format, N.colorSpace),
      at = s.convert(N.type),
      ut = y(N.internalFormat, _t, at, N.colorSpace),
      zt = n.get(_),
      Q = n.get(N);
    if (((Q.__renderTarget = _), !zt.__hasExternalTextures)) {
      const dt = Math.max(1, _.width >> G),
        Tt = Math.max(1, _.height >> G);
      j === i.TEXTURE_3D || j === i.TEXTURE_2D_ARRAY
        ? e.texImage3D(j, G, ut, dt, Tt, _.depth, 0, _t, at, null)
        : e.texImage2D(j, G, ut, dt, Tt, 0, _t, at, null);
    }
    e.bindFramebuffer(i.FRAMEBUFFER, E),
      Ot(_)
        ...
        : (j === i.TEXTURE_2D ||
          ...
          i.framebufferTexture2D(i.FRAMEBUFFER, Y, j, Q.__webglTexture, G),
  ...
  function st(E, _, N) {
    if ((i.bindRenderbuffer(i.RENDERBUFFER, E), _.depthBuffer)) {
      ...
      Ot(_)
        ...
        i.framebufferRenderbuffer(i.FRAMEBUFFER, _t, i.RENDERBUFFER, E);
    } else {
      const Y = _.textures;
      for (let j = 0; j < Y.length; j++) {
        const G = Y[j],
          _t = s.convert(G.format, G.colorSpace),
          at = s.convert(G.type),
          ut = y(G.internalFormat, _t, at, G.colorSpace),
          zt = Ft(_);
        N && Ot(_) === !1
          ? i.renderbufferStorageMultisample(
              i.RENDERBUFFER,
  ...
  function kt(E) {
    ...
    if (E.depthTexture && !_.__autoAllocateDepthBuffer) {
      ...
      for (let Y = 0; Y < 6; Y++)
        if (
          ...
          (_.__webglDepthbuffer[Y] = i.createRenderbuffer()),
            st(_.__webglDepthbuffer[Y], E, !1);
        else {
          const j = E.stencilBuffer
              ? i.DEPTH_STENCIL_ATTACHMENT
              : i.DEPTH_ATTACHMENT,
            G = _.__webglDepthbuffer[Y];
          i.bindRenderbuffer(i.RENDERBUFFER, G),
            i.framebufferRenderbuffer(i.FRAMEBUFFER, j, i.RENDERBUFFER, G);
        }
    } else if (
      ...
      (_.__webglDepthbuffer = i.createRenderbuffer()),
        st(_.__webglDepthbuffer, E, !1);
    else {
      const Y = E.stencilBuffer
          ? i.DEPTH_STENCIL_ATTACHMENT
          : i.DEPTH_ATTACHMENT,
    ...
    if (
      ...
      for (let at = 0; at < 6; at++)
        if (_.mipmaps && _.mipmaps.length > 0) {
          ...
          for (let ut = 0; ut < _.mipmaps.length; ut++)
            N.__webglFramebuffer[at][ut] = i.createFramebuffer();
        } else N.__webglFramebuffer[at] = i.createFramebuffer();
    } else {
      if (_.mipmaps && _.mipmaps.length > 0) {
        N.__webglFramebuffer = [];
        for (let at = 0; at < _.mipmaps.length; at++)
          N.__webglFramebuffer[at] = i.createFramebuffer();
      ...
      if (E.samples > 0 && Ot(E) === !1) {
        ...
        for (let at = 0; at < j.length; at++) {
          const ut = j[at];
          (N.__webglColorRenderbuffer[at] = i.createRenderbuffer()),
            i.bindRenderbuffer(i.RENDERBUFFER, N.__webglColorRenderbuffer[at]);
          const zt = s.convert(ut.format, ut.colorSpace),
            Q = s.convert(ut.type),
            dt = y(
              ut.internalFormat,
              zt,
          ...
          i.renderbufferStorageMultisample(
            ...
            i.framebufferRenderbuffer(
              ...
              i.RENDERBUFFER,
              N.__webglColorRenderbuffer[at]
            );
        }
        i.bindRenderbuffer(i.RENDERBUFFER, null),
          E.depthBuffer &&
            ((N.__webglDepthRenderbuffer = i.createRenderbuffer()),
            st(N.__webglDepthRenderbuffer, E, !0)),
          e.bindFramebuffer(i.FRAMEBUFFER, null);
      }
    }
    if (G) {
      ...
      for (let at = 0; at < 6; at++)
        if (_.mipmaps && _.mipmaps.length > 0)
          for (let ut = 0; ut < _.mipmaps.length; ut++)
            mt(
              N.__webglFramebuffer[at][ut],
              E,
              _,
              i.COLOR_ATTACHMENT0,
              i.TEXTURE_CUBE_MAP_POSITIVE_X + at,
              ut
            );
        else
          mt(
      ...
      if (
        ((E.isWebGL3DRenderTarget || E.isWebGLArrayRenderTarget) &&
          (at = E.isWebGL3DRenderTarget ? i.TEXTURE_3D : i.TEXTURE_2D_ARRAY),
        e.bindTexture(at, Y.__webglTexture),
        Ut(at, _),
        _.mipmaps && _.mipmaps.length > 0)
      )
        for (let ut = 0; ut < _.mipmaps.length; ut++)
          mt(N.__webglFramebuffer[ut], E, _, i.COLOR_ATTACHMENT0, at, ut);
  ...
  function te(E) {
    ...
    for (let N = 0, Y = _.length; N < Y; N++) {
      ...
      if (p(j)) {
        ...
        e.bindTexture(G, _t), h(G), e.unbindTexture();
      }
    }
  }
  const Nt = [],
      ...
      if (Ot(E) === !1) {
        ...
        for (let ut = 0; ut < _.length; ut++) {
          if (
            ...
            const zt = n.get(_[ut]).__webglTexture;
            i.framebufferTexture2D(
              i.DRAW_FRAMEBUFFER,
              i.COLOR_ATTACHMENT0,
              i.TEXTURE_2D,
          ...
          i.blitFramebuffer(0, 0, N, Y, 0, 0, N, Y, j, i.NEAREST),
            l === !0 &&
              ((Nt.length = 0),
              (b.length = 0),
              Nt.push(i.COLOR_ATTACHMENT0 + ut),
              E.depthBuffer &&
                E.resolveDepthBuffer === !1 &&
                (Nt.push(G),
                b.push(G),
                i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER, b)),
              i.invalidateFramebuffer(i.READ_FRAMEBUFFER, Nt));
        }
        if (
  ...
  function e(n, r = fn) {
    ...
    if (n === nr || n === ir || n === rr || n === sr)
      if (a === qt)
        if (((s = t.get('WEBGL_compressed_texture_s3tc_srgb')), s !== null)) {
          ...
          if (n === rr) return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;
        ...
        if (n === rr) return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;
    ...
    if (n === as || n === os || n === ls || n === cs)
      if (((s = t.get('WEBGL_compressed_texture_pvrtc')), s !== null)) {
        ...
        if (n === cs) return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG;
      } else return null;
    if (n === hs || n === us || n === ds)
    ...
    if (n === po || n === Cs || n === Ps || n === Ds)
      if (((s = t.get('EXT_texture_compression_rgtc')), s !== null)) {
        if (n === ar) return s.COMPRESSED_RED_RGTC1_EXT;
        if (n === Cs) return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;
...
class Jf {
  ...
  getMesh(t) {
    if (this.texture !== null && this.mesh === null) {
      ...
      this.mesh = new We(new fr(20, 20), n);
    }
    return this.mesh;
  }
  reset() {
  ...
  constructor(t, e) {
    ...
    (this.cameraAutoUpdate = !0),
      ...
      (this.getControllerGrip = function (W) {
        let tt = y[W];
        return (
          tt === void 0 && ((tt = new Br()), (y[W] = tt)), tt.getGripSpace()
        );
      }),
      (this.getHand = function (W) {
        let tt = y[W];
        return (
          tt === void 0 && ((tt = new Br()), (y[W] = tt)), tt.getHandSpace()
        );
      });
    function z(W) {
      const tt = T.indexOf(W.inputSource);
      if (tt === -1) return;
      const mt = y[tt];
      mt !== void 0 &&
        (mt.update(W.inputSource, W.frame, c || a),
        mt.dispatchEvent({ type: W.type, data: W.inputSource }));
    }
    function Z() {
      ...
      for (let W = 0; W < y.length; W++) {
        const tt = T[W];
        tt !== null && ((T[W] = null), y[W].disconnect(tt));
      }
      (w = null),
        (k = null),
        M.reset(),
        ...
        if (((r = W), r !== null)) {
          if (
            ...
            let mt = null,
              ...
              Et = null;
            p.depth &&
              ((Et = p.stencil ? e.DEPTH24_STENCIL8 : e.DEPTH_COMPONENT24),
              (mt = p.stencil ? ui : si),
              (st = p.stencil ? hi : In));
            const kt = {
              colorFormat: e.RGBA8,
            ...
            (m = new XRWebGLLayer(r, e, mt)),
              ...
              (A = new Nn(m.framebufferWidth, m.framebufferHeight, {
                format: He,
                type: rn,
                colorSpace: t.outputColorSpace,
                stencilBuffer: p.stencil,
    ...
    function K(W) {
      for (let tt = 0; tt < W.removed.length; tt++) {
        const mt = W.removed[tt],
          st = T.indexOf(mt);
        st >= 0 && ((T[st] = null), y[st].disconnect(mt));
      }
    ...
    function V(W, tt, mt) {
      X.setFromMatrixPosition(tt.matrixWorld),
        $.setFromMatrixPosition(mt.matrixWorld);
      const st = X.distanceTo($),
        Et = tt.projectionMatrix.elements,
        kt = mt.projectionMatrix.elements,
        yt = Et[14] / (Et[10] - 1),
        ie = Et[14] / (Et[10] + 1),
        te = (Et[9] + 1) / Et[5],
        Nt = (Et[9] - 1) / Et[5],
      ...
      if (
        ...
        const gt = yt + xt,
          ...
          Y = ((te * ie) / E) * gt,
          j = ((Nt * ie) / E) * gt;
        W.projectionMatrix.makePerspective(_, N, Y, j, gt, E),
    ...
    this.updateCamera = function (W) {
      ...
      M.texture !== null &&
        ...
        (x.near = I.near = R.near = tt),
        (x.far = I.far = R.far = mt),
        (w !== x.near || k !== x.far) &&
          (r.updateRenderState({ depthNear: x.near, depthFar: x.far }),
          (w = x.near),
          (k = x.far)),
        (R.layers.mask = W.layers.mask | 2),
        (I.layers.mask = W.layers.mask | 4),
        (x.layers.mask = R.layers.mask | I.layers.mask);
      const st = W.parent,
        Et = x.cameras;
      rt(x, st);
      for (let kt = 0; kt < Et.length; kt++) rt(Et[kt], st);
      Et.length === 2
        ? V(x, R, I)
    ...
    function ht(W, tt, mt) {
      mt === null
        ...
        W.isPerspectiveCamera &&
          ((W.fov = Ls * 2 * Math.atan(1 / W.projectionMatrix.elements[5])),
          (W.zoom = 1));
    }
    ...
    function Ut(W, tt) {
      if (((u = tt.getViewerPose(c || a)), (v = tt), u !== null)) {
        const mt = u.views;
        m !== null &&
          (t.setRenderTargetFramebuffer(A, m.framebuffer),
          t.setRenderTarget(A));
        let st = !1;
        mt.length !== x.cameras.length && ((x.cameras.length = 0), (st = !0));
        for (let yt = 0; yt < mt.length; yt++) {
          const ie = mt[yt];
          let te = null;
          if (m !== null) te = m.getViewport(ie);
          else {
            const b = d.getViewSubImage(f, ie);
            (te = b.viewport),
              yt === 0 &&
          ...
          Nt === void 0 &&
            ...
            (Nt.viewport = new re()),
            (S[yt] = Nt)),
            Nt.matrix.fromArray(ie.transform.matrix),
            Nt.matrix.decompose(Nt.position, Nt.quaternion, Nt.scale),
            Nt.projectionMatrix.fromArray(ie.projectionMatrix),
            Nt.projectionMatrixInverse.copy(Nt.projectionMatrix).invert(),
            Nt.viewport.set(te.x, te.y, te.width, te.height),
            yt === 0 &&
              (x.matrix.copy(Nt.matrix),
              x.matrix.decompose(x.position, x.quaternion, x.scale)),
            st === !0 && x.cameras.push(Nt);
        }
        ...
        if (
          ...
          const yt = d.getDepthInformation(mt[0]);
          yt && yt.isValid && yt.texture && M.init(t, yt, r.renderState);
        }
      }
  ...
  function s(p, h) {
    ...
    y &&
      ...
      y.isCubeTexture &&
        ...
        ((An.y *= -1), (An.z *= -1)),
      p.envMapRotation.value.setFromMatrix4(tp.makeRotationFromEuler(An)),
      (p.flipEnvMap.value =
    ...
    (p.ior.value = h.ior),
      ...
      h.clearcoat > 0 &&
        ...
        h.clearcoatNormalMap &&
          ...
          h.side === Ee && p.clearcoatNormalScale.value.negate())),
...
function np(i, t, e, n) {
  ...
  function u(A) {
    ...
    return (
      ...
      i.bufferData(i.UNIFORM_BUFFER, U, D),
        ...
        if (m(w, D, S, U) === !0) {
          ...
          for (let K = 0; K < z.length; K++) {
            ...
            typeof X == 'number' || typeof X == 'boolean'
              ? ((w.__data[0] = X),
                i.bufferSubData(i.UNIFORM_BUFFER, k + Z, w.__data))
              : X.isMatrix3
  ...
  function m(A, y, T, U) {
      ...
      );
    {
      ...
      if (typeof D == 'number' || typeof D == 'boolean') {
        if (I !== D) return (U[R] = D), !0;
      } else if (I.equals(D) === !1) return I.copy(D), !0;
    }
    return !1;
  }
  function v(A) {
    ...
    const D = T % U;
    return D > 0 && (T += U - D), (A.__size = T), (A.__cache = {}), this;
  }
  function M(A) {
...
class ip {
  constructor(t = {}) {
    ...
    try {
      ...
      if (
        ('setAttribute' in e &&
          e.setAttribute('data-engine', `three.js r${Is}`),
    ...
    function nt() {
      (Ft = new dd(b)),
        ...
        (Ot = new sd(b, Ft, t, Pt)),
        (xt = new qf(b, Ft)),
        Ot.reverseDepthBuffer && f && xt.buffers.depth.setReversed(!0),
        (Jt = new md(b)),
        (gt = new If()),
        (E = new Zf(b, Ft, xt, gt, Ot, Pt, Jt)),
        (_ = new od(T)),
        (N = new ud(T)),
        (Y = new Sc(b)),
        ($t = new id(b, Y)),
        ...
        (bt = new _d(b, Ot, E)),
        (Q = new ad(gt)),
        (_t = new Uf(T, _, N, Ft, Ot, $t, Q)),
        (at = new ep(T, gt)),
        (ut = new Ff()),
        (zt = new Gf(Ft)),
        (Tt = new nd(T, _, N, xt, G, m, l)),
        (dt = new Xf(T, G, Ot)),
        (C = new np(b, Jt, Ot, xt)),
        (ft = new rd(b, Ft, Jt)),
        (Bt = new pd(b, Ft, Jt)),
    ...
    (this.xr = H),
      ...
      (this.setPixelRatio = function (g) {
        g !== void 0 && ((V = g), this.setSize(X, $, !1));
      }),
      (this.getSize = function (g) {
        return g.set(X, $);
      }),
      (this.setSize = function (g, P, O = !0) {
        if (H.isPresenting) {
          console.warn(
        ...
        (X = g),
          ($ = P),
          (e.width = Math.floor(g * V)),
          (e.height = Math.floor(P * V)),
          O === !0 && ((e.style.width = g + 'px'), (e.style.height = P + 'px')),
          this.setViewport(0, 0, g, P);
      }),
      (this.getDrawingBufferSize = function (g) {
        return g.set(X * V, $ * V).floor();
      }),
      (this.setDrawingBufferSize = function (g, P, O) {
        (X = g),
          ($ = P),
          (V = O),
      ...
      (this.setViewport = function (g, P, O, B) {
        g.isVector4 ? vt.set(g.x, g.y, g.z, g.w) : vt.set(g, P, O, B),
          xt.viewport(w.copy(vt).multiplyScalar(V).round());
      }),
      (this.getScissor = function (g) {
        return g.copy(Ut);
      }),
      (this.setScissor = function (g, P, O, B) {
        g.isVector4 ? Ut.set(g.x, g.y, g.z, g.w) : Ut.set(g, P, O, B),
          xt.scissor(k.copy(Ut).multiplyScalar(V).round());
      }),
      (this.getScissorTest = function () {
        return jt;
      }),
      (this.setScissorTest = function (g) {
        xt.setScissorTest((jt = g));
      }),
      ...
      (this.getClearColor = function (g) {
        return g.copy(Tt.getClearColor());
      }),
      ...
      (this.clear = function (g = !0, P = !0, O = !0) {
        let B = 0;
        if (g) {
          let L = !1;
          if (I !== null) {
          ...
          if (L) {
            ...
            it
              ? ((v[0] = At),
                ...
                (v[2] = Mt),
                (v[3] = pt),
                b.clearBufferuiv(b.COLOR, 0, v))
              : ((M[0] = At),
                (M[1] = Rt),
                (M[2] = Mt),
                (M[3] = pt),
                b.clearBufferiv(b.COLOR, 0, M));
          } else B |= b.COLOR_BUFFER_BIT;
        }
        P && (B |= b.DEPTH_BUFFER_BIT),
          O &&
      ...
      (this.dispose = function () {
        e.removeEventListener('webglcontextlost', q, !1),
          ...
          _t.dispose(),
          H.dispose(),
          H.removeEventListener('sessionstart', Zs),
          H.removeEventListener('sessionend', Ks),
          xn.stop();
      });
    function q(g) {
      g.preventDefault(),
    ...
    function wt(g) {
      const P = g.target;
      P.removeEventListener('dispose', wt), ee(P);
    }
    function ee(g) {
      fe(g), gt.remove(g);
    }
    function fe(g) {
      const P = gt.get(g).programs;
      P !== void 0 &&
    ...
    this.renderBufferDirect = function (g, P, O, B, L, J) {
      P === null && (P = ie);
      ...
      const Rt = O.drawRange,
        Mt = O.attributes.position;
      let Ht = Rt.start * At,
        Wt = (Rt.start + Rt.count) * At;
      J !== null &&
        ((Ht = Math.max(Ht, J.start * At)),
        (Wt = Math.min(Wt, (J.start + J.count) * At))),
        pt !== null
          ? ((Ht = Math.max(Ht, 0)), (Wt = Math.min(Wt, pt.count)))
          : Mt != null &&
            ((Ht = Math.max(Ht, 0)), (Wt = Math.min(Wt, Mt.count)));
      const se = Wt - Ht;
      ...
      let ne,
        Vt = ft;
      if (
        (pt !== null && ((ne = Y.get(pt)), (Vt = Bt), Vt.setIndex(ne)),
        L.isMesh)
      )
        B.wireframe === !0
          ? (xt.setLineWidth(B.wireframeLinewidth * Nt()), Vt.setMode(b.LINES))
          : Vt.setMode(b.TRIANGLES);
      else if (L.isLine) {
        let St = B.linewidth;
        St === void 0 && (St = 1),
          xt.setLineWidth(St * Nt()),
          L.isLineSegments
            ? Vt.setMode(b.LINES)
            : L.isLineLoop
        ...
        L.isPoints
          ? Vt.setMode(b.POINTS)
          : L.isSprite && Vt.setMode(b.TRIANGLES);
      if (L.isBatchedMesh)
        if (L._multiDrawInstances !== null)
          ...
          const St = L._multiDrawStarts,
            de = L._multiDrawCounts,
            Xt = L._multiDrawCount,
            Ne = pt ? Y.get(pt).bytesPerElement : 1,
            Hn = gt.get(B).currentProgram.getUniforms();
          for (let Te = 0; Te < Xt; Te++)
            Hn.setValue(b, '_gl_DrawID', Te), Vt.render(St[Te] / Ne, de[Te]);
        }
      else if (L.isInstancedMesh) Vt.renderInstances(Ht, se, L.count);
      else if (O.isInstancedBufferGeometry) {
        const St = O._maxInstanceCount !== void 0 ? O._maxInstanceCount : 1 / 0,
          de = Math.min(O.instanceCount, St);
        Vt.renderInstances(Ht, se, de);
      } else Vt.render(Ht, se);
    };
    function Yt(g, P, O) {
      g.transparent === !0 && g.side === Qe && g.forceSinglePass === !1
        ? ((g.side = Ee),
          (g.needsUpdate = !0),
          Li(g, P, O),
          (g.side = _n),
    ...
    (this.compile = function (g, P, O = null) {
      O === null && (O = g),
        (h = zt.get(O)),
        h.init(P),
        y.push(h),
      ...
      return (
        g.traverse(function (L) {
          ...
          if (J)
            ...
            else Yt(J, O, L), B.add(J);
        }),
        (h = y.pop()),
        B
      );
    }),
      (this.compileAsync = function (g, P, O = null) {
        const B = this.compile(g, P, O);
        return new Promise((L) => {
          function J() {
            if (
              (B.forEach(function (it) {
                gt.get(it).currentProgram.isReady() && B.delete(it);
              }),
              B.size === 0)
            ) {
              L(g);
    ...
    const xn = new Co();
    xn.setAnimationLoop(Ye),
      typeof self < 'u' && xn.setContext(self),
      (this.setAnimationLoop = function (g) {
        (Ie = g), H.setAnimationLoop(g), g === null ? xn.stop() : xn.start();
      }),
      H.addEventListener('sessionstart', Zs),
      H.addEventListener('sessionend', Ks),
      (this.render = function (g, P) {
        ...
        if (
          ...
          H.enabled === !0 &&
            H.isPresenting === !0 &&
            (H.cameraAutoUpdate === !0 && H.updateCamera(P),
            (P = H.getCamera())),
          g.isScene === !0 && g.onBeforeRender(T, g, P, I),
          (h = zt.get(g, y.length)),
          h.init(P),
          y.push(h),
          Et.multiplyMatrices(P.projectionMatrix, P.matrixWorldInverse),
          W.setFromProjectionMatrix(Et),
          ...
          J !== null && mr(J, P, -1 / 0, T.sortObjects);
        }
        mr(g, P, 0, T.sortObjects),
          p.finish(),
          T.sortObjects === !0 && p.sort(rt, ht),
          (te =
            H.enabled === !1 ||
            H.isPresenting === !1 ||
            H.hasDepthSensing() === !1),
          te && Tt.addToRenderList(p, g),
        ...
        if ((h.setupLights(), P.isArrayCamera)) {
          ...
          for (let it = 0, ct = J.length; it < ct; it++) {
            const pt = J[it];
            js(p, g, pt, pt.viewport);
          }
        } else L.length > 0 && $s(B, L, g, P), te && Tt.render(g), js(p, g, P);
        I !== null &&
          R === 0 &&
          (E.updateMultisampleRenderTarget(I), E.updateRenderTargetMipmap(I)),
          g.isScene === !0 && g.onAfterRender(T, g, P),
          $t.resetDefaultState(),
          (S = -1),
          (x = null),
          y.pop(),
          y.length > 0
            ? ((h = y[y.length - 1]),
              tt === !0 && Q.setGlobalState(T.clippingPlanes, h.state.camera))
            : (h = null),
          A.pop(),
      ...
      if (g.layers.test(P.layers)) {
        if (g.isGroup) O = g.renderOrder;
          ...
          if (!g.frustumCulled || W.intersectsSprite(g)) {
            B && yt.setFromMatrixPosition(g.matrixWorld).applyMatrix4(Et);
            const it = G.update(g),
              ct = g.material;
            ct.visible && p.push(g, it, ct, O, yt.z, null);
          }
        } else if (
            ...
            (B &&
              (g.boundingSphere !== void 0
                ? (g.boundingSphere === null && g.computeBoundingSphere(),
                  yt.copy(g.boundingSphere.center))
                : (it.boundingSphere === null && it.computeBoundingSphere(),
                  yt.copy(it.boundingSphere.center)),
              yt.applyMatrix4(g.matrixWorld).applyMatrix4(Et)),
            Array.isArray(ct))
          ) {
            const pt = it.groups;
            for (let At = 0, Rt = pt.length; At < Rt; At++) {
              const Mt = pt[At],
                Ht = ct[Mt.materialIndex];
              Ht && Ht.visible && p.push(g, it, Ht, O, yt.z, Mt);
            }
          } else ct.visible && p.push(g, it, ct, O, yt.z, null);
        }
      }
      const J = g.children;
      for (let it = 0, ct = J.length; it < ct; it++) mr(J[it], P, O, B);
    }
    function js(g, P, O, B) {
      const L = g.opaque,
        J = g.transmissive,
        it = g.transparent;
      h.setupLightsView(O),
        tt === !0 && Q.setGlobalState(T.clippingPlanes, O),
        B && xt.viewport(w.copy(B)),
        L.length > 0 && Di(L, P, O),
        J.length > 0 && Di(J, P, O),
        it.length > 0 && Di(it, P, O),
    ...
    function $s(g, P, O, B) {
      ...
      h.state.transmissionRenderTarget[B.id] === void 0 &&
        (h.state.transmissionRenderTarget[B.id] = new Nn(1, 1, {
          generateMipmaps: !0,
          type:
      ...
      const J = h.state.transmissionRenderTarget[B.id],
        it = B.viewport || w;
      J.setSize(
        it.z * T.transmissionResolutionScale,
        it.w * T.transmissionResolutionScale
      );
      ...
      if (
        ...
        h.setupLightsView(B),
        tt === !0 && Q.setGlobalState(T.clippingPlanes, B),
        Di(g, O, B),
        E.updateMultisampleRenderTarget(J),
        E.updateRenderTargetMipmap(J),
        ...
        for (let Mt = 0, Ht = P.length; Mt < Ht; Mt++) {
          const Wt = P[Mt],
            ...
            Vt = Wt.material,
            St = Wt.group;
          if (Vt.side === Qe && se.layers.test(B.layers)) {
            const de = Vt.side;
            (Vt.side = Ee),
              (Vt.needsUpdate = !0),
              Js(se, O, B, ne, Vt, St),
        ...
        Rt === !0 &&
          (E.updateMultisampleRenderTarget(J), E.updateRenderTargetMipmap(J));
      }
      T.setRenderTarget(ct),
        T.setClearColor(Z, K),
        At !== void 0 && (B.viewport = At),
        (T.toneMapping = pt);
    }
    function Di(g, P, O) {
      const B = P.isScene === !0 ? P.overrideMaterial : null;
      for (let L = 0, J = g.length; L < J; L++) {
        const it = g[L],
          ct = it.object,
          pt = it.geometry,
          At = B === null ? it.material : B,
          Rt = it.group;
        ct.layers.test(O.layers) && Js(ct, P, O, pt, At, Rt);
      }
    }
    function Js(g, P, O, B, L, J) {
      g.onBeforeRender(T, P, O, B, L, J),
        g.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse, g.matrixWorld),
        g.normalMatrix.getNormalMatrix(g.modelViewMatrix),
        L.onBeforeRender(T, P, O, B, g, J),
        L.transparent === !0 && L.side === Qe && L.forceSinglePass === !1
          ? ((L.side = Ee),
            (L.needsUpdate = !0),
            T.renderBufferDirect(O, P, B, L, g, J),
            (L.side = _n),
            (L.needsUpdate = !0),
            T.renderBufferDirect(O, P, B, L, g, J),
            (L.side = Qe))
          : T.renderBufferDirect(O, P, B, L, g, J),
        g.onAfterRender(T, P, O, B, L, J);
    }
    function Li(g, P, O) {
      P.isScene !== !0 && (P = ie);
      const B = gt.get(g),
        ...
        it = L.state.version,
        ct = _t.getParameters(g, L.state, J, P, O),
        pt = _t.getProgramCacheKey(ct);
      let At = B.programs;
      (B.environment = g.isMeshStandardMaterial ? P.environment : null),
        (B.fog = P.fog),
        (B.envMap = (g.isMeshStandardMaterial ? N : _).get(
          g.envMap || B.environment
        )),
        (B.envMapRotation =
          B.environment !== null && g.envMap === null
      ...
      if (Rt !== void 0) {
        ...
        (ct.uniforms = _t.getUniforms(g)),
          g.onBeforeCompile(ct, T),
          (Rt = _t.acquireProgram(ct, pt)),
          At.set(pt, Rt),
    ...
    function Qs(g) {
      if (g.uniformsList === null) {
        ...
        g.uniformsList = lr.seqWithValue(P.seq, g.uniforms);
      }
    ...
    function Bo(g, P, O, B, L) {
      P.isScene !== !0 && (P = ie), E.resetTextureUnits();
      const J = P.fog,
        it = B.isMeshStandardMaterial ? P.environment : null,
        ct =
          I === null
            ? T.outputColorSpace
            ...
            : di,
        pt = (B.isMeshStandardMaterial ? N : _).get(B.envMap || it),
        At =
          B.vertexColors === !0 &&
          !!O.attributes.color &&
          O.attributes.color.itemSize === 4,
        Rt = !!O.attributes.tangent && (!!B.normalMap || B.anisotropy > 0),
        Mt = !!O.morphAttributes.position,
        Ht = !!O.morphAttributes.normal,
        Wt = !!O.morphAttributes.color;
      let se = mn;
      B.toneMapped &&
      ...
      let Xt = !1;
      B.version === St.__version
        ? ((St.needsLights && St.lightsStateVersion !== de.state.version) ||
            St.outputColorSpace !== ct ||
            (L.isBatchedMesh && St.batching === !1) ||
            (!L.isBatchedMesh && St.batching === !0) ||
            (L.isBatchedMesh &&
              St.batchingColor === !0 &&
              L.colorTexture === null) ||
            (L.isBatchedMesh &&
              St.batchingColor === !1 &&
              L.colorTexture !== null) ||
            (L.isInstancedMesh && St.instancing === !1) ||
            (!L.isInstancedMesh && St.instancing === !0) ||
            (L.isSkinnedMesh && St.skinning === !1) ||
            (!L.isSkinnedMesh && St.skinning === !0) ||
            (L.isInstancedMesh &&
            ...
            (L.isInstancedMesh &&
              ...
              L.instanceColor !== null) ||
            (L.isInstancedMesh &&
              St.instancingMorph === !0 &&
              L.morphTexture === null) ||
            (L.isInstancedMesh &&
              St.instancingMorph === !1 &&
              L.morphTexture !== null) ||
            St.envMap !== pt ||
            (B.fog === !0 && St.fog !== J) ||
            (St.numClippingPlanes !== void 0 &&
              (St.numClippingPlanes !== Q.numPlanes ||
                St.numIntersection !== Q.numIntersection)) ||
            St.vertexAlphas !== At ||
            St.vertexTangents !== Rt ||
            St.morphTargets !== Mt ||
            St.morphNormals !== Ht ||
            St.morphColors !== Wt ||
            St.toneMapping !== se ||
            St.morphTargetsCount !== Vt) &&
          (Xt = !0)
        : ((Xt = !0), (St.__version = B.version));
      let Ne = St.currentProgram;
      Xt === !0 && (Ne = Li(B, P, L));
      let Hn = !1,
        Te = !1,
        _i = !1;
      const Qt = Ne.getUniforms(),
        Pe = St.uniforms;
      if (
        (xt.useProgram(Ne.program) && ((Hn = !0), (Te = !0), (_i = !0)),
        B.id !== S && ((S = B.id), (Te = !0)),
        Hn || x !== g)
      ) {
        xt.buffers.depth.getReversed()
          ? (st.copy(g.projectionMatrix),
            Fl(st),
            Ol(st),
            Qt.setValue(b, 'projectionMatrix', st))
          : Qt.setValue(b, 'projectionMatrix', g.projectionMatrix),
          Qt.setValue(b, 'viewMatrix', g.matrixWorldInverse);
        const xe = Qt.map.cameraPosition;
        xe !== void 0 &&
          xe.setValue(b, kt.setFromMatrixPosition(g.matrixWorld)),
          ...
          (B.isMeshPhongMaterial ||
            ...
            B.isShaderMaterial) &&
            Qt.setValue(b, 'isOrthographic', g.isOrthographicCamera === !0),
          x !== g && ((x = g), (Te = !0), (_i = !0));
      }
      if (L.isSkinnedMesh) {
        Qt.setOptional(b, L, 'bindMatrix'),
          Qt.setOptional(b, L, 'bindMatrixInverse');
        const _e = L.skeleton;
        _e &&
          (_e.boneTexture === null && _e.computeBoneTexture(),
          Qt.setValue(b, 'boneTexture', _e.boneTexture, E));
      }
      L.isBatchedMesh &&
        (Qt.setOptional(b, L, 'batchingTexture'),
        Qt.setValue(b, 'batchingTexture', L._matricesTexture, E),
        Qt.setOptional(b, L, 'batchingIdTexture'),
        Qt.setValue(b, 'batchingIdTexture', L._indirectTexture, E),
        Qt.setOptional(b, L, 'batchingColorTexture'),
        L._colorsTexture !== null &&
          Qt.setValue(b, 'batchingColorTexture', L._colorsTexture, E));
      ...
      if (
        ((De.position !== void 0 ||
          ...
          De.color !== void 0) &&
          bt.update(L, O, Ne),
        (Te || St.receiveShadow !== L.receiveShadow) &&
          ((St.receiveShadow = L.receiveShadow),
          Qt.setValue(b, 'receiveShadow', L.receiveShadow)),
        ...
        B.isMeshStandardMaterial &&
          B.envMap === null &&
          P.environment !== null &&
          (Pe.envMapIntensity.value = P.environmentIntensity),
        Te &&
          (Qt.setValue(b, 'toneMappingExposure', T.toneMappingExposure),
          St.needsLights && zo(Pe, _i),
          J && B.fog === !0 && at.refreshFogUniforms(Pe, J),
          ...
          lr.upload(b, Qs(St), Pe, E)),
        B.isShaderMaterial &&
          B.uniformsNeedUpdate === !0 &&
          (lr.upload(b, Qs(St), Pe, E), (B.uniformsNeedUpdate = !1)),
        B.isSpriteMaterial && Qt.setValue(b, 'center', L.center),
        Qt.setValue(b, 'modelViewMatrix', L.modelViewMatrix),
        Qt.setValue(b, 'normalMatrix', L.normalMatrix),
        Qt.setValue(b, 'modelMatrix', L.matrixWorld),
        B.isShaderMaterial || B.isRawShaderMaterial)
      ) {
        const _e = B.uniformsGroups;
        for (let xe = 0, _r = _e.length; xe < _r; xe++) {
          const Mn = _e[xe];
          C.update(Mn, Ne), C.bind(Mn, Ne);
        }
      }
      return Ne;
    }
    ...
    (this.getActiveCubeFace = function () {
      ...
      (this.setRenderTargetTextures = function (g, P, O) {
        (gt.get(g.texture).__webglTexture = P),
          (gt.get(g.depthTexture).__webglTexture = O);
        const B = gt.get(g);
        (B.__hasExternalTextures = !0),
          (B.__autoAllocateDepthBuffer = O === void 0),
          B.__autoAllocateDepthBuffer ||
            (Ft.has('WEBGL_multisampled_render_to_texture') === !0 &&
              (console.warn(
    ...
    const Vo = b.createFramebuffer();
    (this.setRenderTarget = function (g, P = 0, O = 0) {
      (I = g), (D = P), (R = O);
      let B = !0,
        L = null,
        J = !1,
      ...
      if (g) {
        ...
        if (pt.__useDefaultFramebuffer !== void 0)
          xt.bindFramebuffer(b.FRAMEBUFFER, null), (B = !1);
        else if (pt.__webglFramebuffer === void 0) E.setupRenderTarget(g);
        else if (pt.__hasExternalTextures)
          E.rebindTextures(
            g,
            gt.get(g.texture).__webglTexture,
            gt.get(g.depthTexture).__webglTexture
          );
        ...
        (At.isData3DTexture ||
          ...
          (it = !0);
        const Rt = gt.get(g).__webglFramebuffer;
        g.isWebGLCubeRenderTarget
          ? (Array.isArray(Rt[P]) ? (L = Rt[P][O]) : (L = Rt[P]), (J = !0))
          : g.samples > 0 && E.useMultisampledRTT(g) === !1
          ? (L = gt.get(g).__webglMultisampledFramebuffer)
          : Array.isArray(Rt)
          ? (L = Rt[O])
          : (L = Rt),
          w.copy(g.viewport),
        ...
        w.copy(vt).multiplyScalar(V).floor(),
          k.copy(Ut).multiplyScalar(V).floor(),
          (z = jt);
      if (
        (O !== 0 && (L = Vo),
        xt.bindFramebuffer(b.FRAMEBUFFER, L) && B && xt.drawBuffers(g, L),
        xt.viewport(w),
        xt.scissor(k),
        xt.setScissorTest(z),
        J)
      ) {
        const pt = gt.get(g.texture);
        b.framebufferTexture2D(
          b.FRAMEBUFFER,
          b.COLOR_ATTACHMENT0,
          b.TEXTURE_CUBE_MAP_POSITIVE_X + P,
          pt.__webglTexture,
          O
        );
      } else if (it) {
      ...
      (this.readRenderTargetPixels = function (g, P, O, B, L, J, it) {
        ...
        let ct = gt.get(g).__webglFramebuffer;
        if ((g.isWebGLCubeRenderTarget && it !== void 0 && (ct = ct[it]), ct)) {
          ...
          try {
            ...
            P >= 0 &&
              ...
              O >= 0 &&
              O <= g.height - L &&
              b.readPixels(P, O, B, L, Pt.convert(At), Pt.convert(Rt), J);
          } finally {
            const pt = I !== null ? gt.get(I).__webglFramebuffer : null;
            xt.bindFramebuffer(b.FRAMEBUFFER, pt);
          }
        }
      }),
      (this.readRenderTargetPixelsAsync = async function (
        ...
        if ((g.isWebGLCubeRenderTarget && it !== void 0 && (ct = ct[it]), ct)) {
          ...
          if (P >= 0 && P <= g.width - B && O >= 0 && O <= g.height - L) {
            xt.bindFramebuffer(b.FRAMEBUFFER, ct);
            const Mt = b.createBuffer();
            b.bindBuffer(b.PIXEL_PACK_BUFFER, Mt),
              b.bufferData(b.PIXEL_PACK_BUFFER, J.byteLength, b.STREAM_READ),
              b.readPixels(P, O, B, L, Pt.convert(At), Pt.convert(Rt), 0);
            const Ht = I !== null ? gt.get(I).__webglFramebuffer : null;
            xt.bindFramebuffer(b.FRAMEBUFFER, Ht);
            const Wt = b.fenceSync(b.SYNC_GPU_COMMANDS_COMPLETE, 0);
            return (
              b.flush(),
              await Nl(b, Wt, 4),
              b.bindBuffer(b.PIXEL_PACK_BUFFER, Mt),
              b.getBufferSubData(b.PIXEL_PACK_BUFFER, 0, J),
              b.deleteBuffer(Mt),
              b.deleteSync(Wt),
              J
            );
      ...
      (this.copyFramebufferToTexture = function (g, P = null, O = 0) {
        g.isTexture !== !0 &&
          (Rn(
        ...
        const B = Math.pow(2, -O),
          L = Math.floor(g.image.width * B),
          J = Math.floor(g.image.height * B),
          it = P !== null ? P.x : 0,
          ct = P !== null ? P.y : 0;
        E.setTexture2D(g, 0),
          b.copyTexSubImage2D(b.TEXTURE_2D, O, 0, 0, it, ct, L, J),
          xt.unbindTexture();
      });
    const Go = b.createFramebuffer(),
      ko = b.createFramebuffer();
    (this.copyTextureToTexture = function (
        ...
        J === null &&
          (L !== 0
            ? (Rn(
              ...
              (L = 0))
            : (J = 0));
      let it, ct, pt, At, Rt, Mt, Ht, Wt, se;
      const ne = g.isCompressedTexture ? g.mipmaps[J] : g.image;
      if (O !== null)
        (it = O.max.x - O.min.x),
          (ct = O.max.y - O.min.y),
          (pt = O.isBox3 ? O.max.z - O.min.z : 1),
          (At = O.min.x),
          (Rt = O.min.y),
          (Mt = O.isBox3 ? O.min.z : 0);
      else {
        const De = Math.pow(2, -L);
        (it = Math.floor(ne.width * De)),
          (ct = Math.floor(ne.height * De)),
          g.isDataArrayTexture
            ? (pt = ne.depth)
            : g.isData3DTexture
            ? (pt = Math.floor(ne.depth * De))
            : (pt = 1),
          (At = 0),
          (Rt = 0),
          (Mt = 0);
      ...
      B !== null
        ? ((Ht = B.x), (Wt = B.y), (se = B.z))
        : ((Ht = 0), (Wt = 0), (se = 0));
      const Vt = Pt.convert(P.format),
        St = Pt.convert(P.type);
      let de;
      P.isData3DTexture
        ? (E.setTexture3D(P, 0), (de = b.TEXTURE_3D))
        : P.isDataArrayTexture || P.isCompressedArrayTexture
        ? (E.setTexture2DArray(P, 0), (de = b.TEXTURE_2D_ARRAY))
        : (E.setTexture2D(P, 0), (de = b.TEXTURE_2D)),
        b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL, P.flipY),
        b.pixelStorei(b.UNPACK_PREMULTIPLY_ALPHA_WEBGL, P.premultiplyAlpha),
        b.pixelStorei(b.UNPACK_ALIGNMENT, P.unpackAlignment);
      const Xt = b.getParameter(b.UNPACK_ROW_LENGTH),
        Ne = b.getParameter(b.UNPACK_IMAGE_HEIGHT),
        Hn = b.getParameter(b.UNPACK_SKIP_PIXELS),
        Te = b.getParameter(b.UNPACK_SKIP_ROWS),
        _i = b.getParameter(b.UNPACK_SKIP_IMAGES);
      b.pixelStorei(b.UNPACK_ROW_LENGTH, ne.width),
        b.pixelStorei(b.UNPACK_IMAGE_HEIGHT, ne.height),
        b.pixelStorei(b.UNPACK_SKIP_PIXELS, At),
        b.pixelStorei(b.UNPACK_SKIP_ROWS, Rt),
        b.pixelStorei(b.UNPACK_SKIP_IMAGES, Mt);
      const Qt = g.isDataArrayTexture || g.isData3DTexture,
        Pe = P.isDataArrayTexture || P.isData3DTexture;
      if (g.isDepthTexture) {
        const De = gt.get(g),
          _e = gt.get(P),
          xe = gt.get(De.__renderTarget),
          _r = gt.get(_e.__renderTarget);
        xt.bindFramebuffer(b.READ_FRAMEBUFFER, xe.__webglFramebuffer),
          xt.bindFramebuffer(b.DRAW_FRAMEBUFFER, _r.__webglFramebuffer);
        for (let Mn = 0; Mn < pt; Mn++)
          Qt &&
            (b.framebufferTextureLayer(
              b.READ_FRAMEBUFFER,
              b.COLOR_ATTACHMENT0,
              gt.get(g).__webglTexture,
              L,
              Mt + Mn
            ),
            b.framebufferTextureLayer(
        ...
        xt.bindFramebuffer(b.READ_FRAMEBUFFER, null),
          xt.bindFramebuffer(b.DRAW_FRAMEBUFFER, null);
      } else if (L !== 0 || g.isRenderTargetTexture || gt.has(g)) {
        const De = gt.get(g),
          _e = gt.get(P);
        xt.bindFramebuffer(b.READ_FRAMEBUFFER, Go),
          xt.bindFramebuffer(b.DRAW_FRAMEBUFFER, ko);
        for (let xe = 0; xe < pt; xe++)
          Qt
            ? b.framebufferTextureLayer(
                b.READ_FRAMEBUFFER,
                b.COLOR_ATTACHMENT0,
            ...
            L !== 0
              ...
              : Pe
              ? b.copyTexSubImage3D(de, J, Ht, Wt, se + xe, At, Rt, it, ct)
              : b.copyTexSubImage2D(de, J, Ht, Wt, At, Rt, it, ct);
        xt.bindFramebuffer(b.READ_FRAMEBUFFER, null),
          xt.bindFramebuffer(b.DRAW_FRAMEBUFFER, null);
      } else
        Pe
          ? g.isDataTexture || g.isData3DTexture
            ? b.texSubImage3D(de, J, Ht, Wt, se, it, ct, pt, Vt, St, ne.data)
            ...
            : b.texSubImage3D(de, J, Ht, Wt, se, it, ct, pt, Vt, St, ne)
          : g.isDataTexture
          ? b.texSubImage2D(b.TEXTURE_2D, J, Ht, Wt, it, ct, Vt, St, ne.data)
          ...
          : b.texSubImage2D(b.TEXTURE_2D, J, Ht, Wt, it, ct, Vt, St, ne);
      b.pixelStorei(b.UNPACK_ROW_LENGTH, Xt),
        b.pixelStorei(b.UNPACK_IMAGE_HEIGHT, Ne),
        b.pixelStorei(b.UNPACK_SKIP_PIXELS, Hn),
        b.pixelStorei(b.UNPACK_SKIP_ROWS, Te),
        b.pixelStorei(b.UNPACK_SKIP_IMAGES, _i),
        J === 0 && P.generateMipmaps && b.generateMipmap(de),
        xt.unbindTexture();
    }),
      (this.copyTextureToTexture3D = function (
        ...
        return (
          ...
          this.copyTextureToTexture(g, P, O, B, L)
        );
      }),
      (this.initRenderTarget = function (g) {
        gt.get(g).__webglFramebuffer === void 0 && E.setupRenderTarget(g);
      }),
      (this.initTexture = function (g) {
        g.isCubeTexture
          ? E.setTextureCube(g, 0)
          : g.isData3DTexture
          ? E.setTexture3D(g, 0)
          : g.isDataArrayTexture || g.isCompressedArrayTexture
          ? E.setTexture2DArray(g, 0)
          : E.setTexture2D(g, 0),
          xt.unbindTexture();
      }),
      (this.resetState = function () {
        (D = 0), (R = 0), (I = null), xt.reset(), $t.reset();
      }),
      typeof __THREE_DEVTOOLS__ < 'u' &&
        __THREE_DEVTOOLS__.dispatchEvent(
          new CustomEvent('observe', { detail: this })
...
class sp extends xc {
  constructor(t, e = null) {
    super(t, e),
      ...
      (this._quat = new Fn().setFromUnitVectors(t.up, new F(0, 1, 0))),
      (this._quatInverse = this._quat.clone().invert()),
      (this._spherical = new Ra()),
      (this._sphericalDelta = new Ra()),
      (this._scale = 1),
      (this._panOffset = new F()),
      (this._rotateStart = new Lt()),
      (this._rotateEnd = new Lt()),
      (this._rotateDelta = new Lt()),
      (this._panStart = new Lt()),
      (this._panEnd = new Lt()),
      (this._panDelta = new Lt()),
      (this._dollyStart = new Lt()),
      (this._dollyEnd = new Lt()),
      (this._dollyDelta = new Lt()),
      ...
      (this._onPointerMove = op.bind(this)),
      (this._onPointerDown = ap.bind(this)),
      (this._onPointerUp = lp.bind(this)),
      (this._onContextMenu = mp.bind(this)),
      (this._onMouseWheel = up.bind(this)),
      (this._onKeyDown = dp.bind(this)),
      (this._onTouchStart = fp.bind(this)),
      (this._onTouchMove = pp.bind(this)),
      (this._onMouseDown = cp.bind(this)),
      (this._onMouseMove = hp.bind(this)),
      (this._interceptControlDown = _p.bind(this)),
  ...
  update(t = null) {
    ...
    if (
      ...
      a !== null &&
        (this.screenSpacePanning
          ...
          : (er.origin.copy(this.object.position),
            er.direction.set(0, 0, -1).transformDirection(this.object.matrix),
            Math.abs(this.object.up.dot(er.direction)) < rp
              ? this.object.lookAt(this.target)
              : (to.setFromNormalAndCoplanarPoint(this.object.up, this.target),
                er.intersectPlane(to, this.target))));
    } else if (this.object.isOrthographicCamera) {
    ...
    return (
      ...
      (this._performCursorZoom = !1),
      s ||
      this._lastPosition.distanceToSquared(this.object.position) > Yr ||
      8 * (1 - this._lastQuaternion.dot(this.object.quaternion)) > Yr ||
      this._lastTargetPosition.distanceToSquared(this.target) > Yr
        ? (this.dispatchEvent(Qa),
  ...
  _trackPointer(t) {
    ...
    e === void 0 && ((e = new Lt()), (this._pointerPositions[t.pointerId] = e)),
...
function cp(i) {
  ...
  this.state !== Zt.NONE && this.dispatchEvent(Ys);
}
function hp(i) {
  switch (this.state) {
    case Zt.ROTATE:
...
const Ci = new wo(),
  zn = new mc(Ci),
  Pi = zn.load('./textures/minecraft.png');
Pi.colorSpace = Ae;
Ci.onStart = () => console.log('lm start');
Ci.onLoad = () => console.log('lm load');
Ci.onProgress = () => console.log('lm progress');
Ci.onError = () => console.log('lm error');
zn.load('./textures/door/alpha.jpg');
zn.load('./textures/door/height.jpg');
zn.load('./textures/door/normal.jpg');
zn.load('./textures/door/ambientOcclusion.jpg');
zn.load('./textures/door/metalness.jpg');
zn.load('./textures/door/roughness.jpg');
Pi.generateMipmaps = !1;
Pi.minFilter = Re;
Pi.magFilter = Re;
const No = document.querySelector('canvas.webgl'),
  qs = new lc(),
  vp = new pi(1, 1, 1),
  xp = new ks({ map: Pi }),
  Mp = new We(vp, xp);
qs.add(Mp);
const Ge = { width: window.innerWidth, height: window.innerHeight };
window.addEventListener('resize', () => {
  (Ge.width = window.innerWidth),
    (Ge.height = window.innerHeight),
    (vn.aspect = Ge.width / Ge.height),
    vn.updateProjectionMatrix(),
    bi.setSize(Ge.width, Ge.height),
    bi.setPixelRatio(Math.min(window.devicePixelRatio, 2));
});
const vn = new Ue(75, Ge.width / Ge.height, 0.1, 100);
vn.position.x = 1;
vn.position.y = 1;
vn.position.z = 1;
qs.add(vn);
const Fo = new sp(vn, No);
Fo.enableDamping = !0;
const bi = new ip({ canvas: No });
bi.setSize(Ge.width, Ge.height);
bi.setPixelRatio(Math.min(window.devicePixelRatio, 2));
const Sp = new vc(),
  Oo = () => {
    Sp.getElapsedTime(),
      Fo.update(),
      bi.render(qs, vn),
      window.requestAnimationFrame(Oo);
  };
Oo();
